<div class="td-admin-doc-box">
    <div class="td-admin-box-text td-admin-box-three">
        <h2>Support forum</h2>
        <p>We offer outstanding support through our forum. To get support first you need to register (create an account) and open a thread in the <?php TD_THEME_NAME ?> Section.</p>
        <a class="button button-primary" href="https://forum.tagdiv.com/forum/newsmag/" target="_blank">Open forum</a>
    </div>
    <div class="td-admin-box-text td-admin-box-three">
        ...
        <a class="button button-primary" href="https://forum.tagdiv.com/newsmag-documentation/" target="_blank">Open documentation</a>
    </div>
