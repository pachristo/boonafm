...
var tdThemeBlocksControls=wp.compose.createHigherOrderComponent(function(c){return function(b){var a=b.name,d="core/image"===a,e="core/quote"===a,f="core/paragraph"===a,g="core/list"===a,h="core/button"===a;a=td_core_blocks_with_custom_spacing.includes(a);var k="undefined"!==typeof b.attributes.id,l=b.attributes.tdImgStyle,m=[{label:__("Default"),value:""},{label:__("Full width"),value:"image-full"},{label:__("Full width and grid border"),value:"image-full-and-grid"},{label:__("Left ( Over grid )"),
value:"image-left"},{label:__("Right ( Over grid )"),value:"image-right"}],n=b.attributes.quoteStyle,p=[{label:__("Default"),value:"td_quote"},{label:__("Quote Left"),value:"td_quote td_quote_left"},{label:__("Quote Right"),value:"td_quote td_quote_right"},{label:__("Quote Box Center"),value:"td_quote_box td_box_center"},{label:__("Quote Box Left"),value:"td_quote_box td_box_left"},{label:__("Quote Box Right"),value:"td_quote_box td_box_right"},{label:__("Pull Quote Center"),value:"td_pull_quote td_pull_center"},
{label:__("Pull Quote Left"),value:"td_pull_quote td_pull_left"},{label:__("Pull Quote Right"),value:"td_pull_quote td_pull_right"}],q=b.attributes.quoteStyle,r=[{label:__("None"),value:""},{label:__("Left"),value:"left"},{label:__("Center"),value:"center"},{label:__("Right"),value:"right"}],t=b.attributes.dropCapStyle,u=[{label:__("Box"),value:"dropcapp"},{label:__("Circle"),value:"dropcapp1"},{label:__("Regular"),value:"dropcapp2"},{label:__("Bold"),value:"dropcapp3"},{label:__("Small Circle"),
value:"dropcapp4"}],v=d||e||f;return el(Fragment,null,el(c,b),h&&el(BlockControls,null,el(withState({activeControl:b.attributes.tdButtonSize?b.attributes.tdButtonSize:"normal"})(function(a){var c=a.activeControl,d=a.setState;return el(Toolbar,{className:"td-button-size-toolbar",controls:[{icon:btnSizeSmall,title:__("Small Button"),isActive:"small"===c,onClick:function(){return d(function(){b.setAttributes({tdButtonSize:"small"})})}},{icon:btnSizeMedium,title:__("Normal Button"),isActive:"normal"===
c,onClick:function(){return d(function(){b.setAttributes({tdButtonSize:"normal"})})}},{icon:btnSizeLarge,title:__("Large Button"),isActive:"large"===c,onClick:function(){return d(function(){b.setAttributes({tdButtonSize:"large"})})}}]})}),null)),el(InspectorControls,null,a&&el(PanelBody,{title:"Theme Settings",className:"components-panel__body td-components-panel__body",initialOpen:v,icon:tagDivIcon},d&&k&&el(withState({checked:b.attributes.tdShowModal})(function(a){var c=a.setState;return el(ToggleControl,
{label:"LightBox",help:"Enable/Disable the Image LightBox",checked:b.attributes.tdShowModal,className:"none"!==b.attributes.linkDestination?"td-disabled-control":"",onChange:function(){return c(function(a){b.setAttributes({tdShowModal:!a.checked});return{checked:!a.checked}})}})}),null),d&&k&&el(SelectControl,{label:"Image Caption Align",value:q,options:r,onChange:function(a){b.setAttributes({tdCaptionAlign:a})}}),d&&k&&el(SelectControl,{label:"Image Styles",value:l,options:m,onChange:function(a){b.setAttributes({tdImgStyle:a})}}),
d&&k&&el(TextControl,{label:"Img Video Popup URL",help:"Add a video popup for this image.",type:"text",value:b.attributes.tdVideoUrl,onChange:function(a){b.setAttributes({tdVideoUrl:a})}}),e&&el(SelectControl,{label:"Quotes Styles",value:n,options:p,onChange:function(a){b.setAttributes({quoteStyle:a})}}),f&&el(SelectControl,{label:"Drop Cap Style",value:t,options:u,onChange:function(a){b.setAttributes({dropCapStyle:a})}}),g&&el(withState({checked:b.attributes.tdArrowListStyle})(function(a){var c=
a.setState;return el(ToggleControl,{label:"Arrowed List",help:"Toggle Arrowed List Format",checked:b.attributes.tdArrowListStyle,onChange:function(){return c(function(a){b.setAttributes({tdArrowListStyle:!a.checked});return{checked:!a.checked}})}})}),null),el("hr",null),el(RangeControl,{label:"Custom Top Margin (px)",value:b.attributes.tdMarginTop,onChange:function(a){b.setAttributes({tdMarginTop:a})},min:-500,max:500}),el(RangeControl,{label:"Custom Bottom Margin (px)",value:b.attributes.tdMarginBottom,
onChange:function(a){b.setAttributes({tdMarginBottom:a})},min:-500,max:500}),el(RangeControl,{label:"Custom Maximum Width (px)",value:b.attributes.tdMaxWidth,onChange:function(a){b.setAttributes({tdMaxWidth:a})},min:100,max:980}))))}},"tdThemeBlocksControls");wp.hooks.addFilter("editor.BlockEdit","td/core-blocks-controls",tdThemeBlocksControls);
...
var tdBlockWithCustomEditorWrapper=wp.compose.createHigherOrderComponent(function(c){return function(b){var a=b.name,d=b.attributes,e={};"core/image"===a&&(e.className=(""!==d.tdCaptionAlign?"td-caption-align-"+d.tdCaptionAlign:"")+" "+(""!==d.tdImgStyle?"td-post-"+d.tdImgStyle:""));"core/quote"===a&&(e.className=""!==d.quoteStyle?d.quoteStyle:"");"core/paragraph"===a&&(e.className=""!==d.dropCapStyle?d.dropCapStyle:"");"core/list"===a&&(e.className=d.tdArrowListStyle?"td-arrow-list":"");"core/button"===
