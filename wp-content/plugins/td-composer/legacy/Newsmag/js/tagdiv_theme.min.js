...
image:{tError:tdUtil.getBackendVar("td_magnific_popup_translation_image_tError"),titleSrc:function(a){a=jQuery(a.el).data("caption");return"undefined"!==typeof a?a:""}},zoom:{enabled:!0,duration:300,opener:function(a){return a.find("img")}},callbacks:{open:function(){var a=jQuery(this.currItem.el).data("caption_align");if("undefined"!==typeof a)return jQuery(".mfp-figure").addClass(a),a},change:function(a){window.tdModalImageLastEl=a.el;tdUtil.scrollIntoView(a.el)},beforeClose:function(){tdAffix.allow_scroll=
