...
function td_theme_migration() {
	...
	/**
	 * auto update of posts should be done on 'after_setup_theme' because of computing shortcodes. Shortcodes are registered here.
	 */
	add_action('after_setup_theme', function() {

		$td_version = td_util::get_option('td_version');

		if ( 'Newspaper' == TD_THEME_NAME && version_compare( $td_version, '10.2', '<' ) && TD_DEPLOY_MODE === 'deploy' ) {
...
// remove google+ social icon and share
