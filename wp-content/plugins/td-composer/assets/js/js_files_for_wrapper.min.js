...
takeSnapshot:function(e){var a={error:b,getShortcode:""};tdcIFrameData.getShortcodeFromData(a);d.isUndefined(a.error)||tdcDebug.log(a.error);if(!d.isUndefined(a.getShortcode)&&""!==a.getShortcode){var c=tdcUtil.b64EncodeUnicode(JSON.stringify(tdcSavePost.getHeaderTemplateData()));if(!tdcRecycle._isLastSnapshot(a.getShortcode,c)){tdcRecycle._currentIndex=0;d.isUndefined(e)&&(e="Restore point");var m=new Date;e=new tdcRecycle.item(m.getTime(),e,a.getShortcode,c);a=tdcRecycle._getIndexPath(tdcSidebar.getCurrentModel());
...
m.toLocaleDateString()+" "+m.toLocaleTimeString()+'</div><div style="width: 350px; float: left">Before '+e.description+'</div><div class="tdc-snapshot-shortcode" style="display: none" data-index_path="'+a+'">'+tdcUtil.b64EncodeUnicode(e.shortcode)+'</div><div class="tdc-snapshot-header" style="display: none">'+e.headerTemplateData+"</div></div>");1<tdcRecycle._items.length&&(tdcRecycle.$_undo.addClass("tdc-restore-active"),tdcRecycle.$_redo.removeClass("tdc-restore-active"));clearTimeout(tdcRecycle._timoutSavingHistory);
...
(function(f,d,b,e){tdcState={_headerTemplateId:"",_headerTemplateContent:"",_isGlobalTemplate:!1,_isNoHeader:!1,_isHeaderSticky:!1,_isMobileHeaderSticky:!1,_isGlobalFooterTemplate:!1,_isNoFooter:!1,init:function(a,c,b,e,m,g,d,l){tdcState.setHeaderTemplateId(a);tdcState.setHeaderTemplateContent(c);b&&tdcState.setGlobalTemplate();e&&tdcState.setNoHeader();tdcState.setFooterTemplateId(m);tdcState.setFooterTemplateContent(g);d&&tdcState.setGlobalFooterTemplate();l&&tdcState.setNoFooter()},setHeaderTemplateId:function(a){tdcState._headerTemplateId=
...
f=window.tdcPostSettings.headerTemplateId;d=window.tdcPostSettings.headerTemplateContent;var a=e=!1,c=window.tdcPostSettings.footerTemplateId,m=window.tdcPostSettings.footerTemplateContent,g=!1,l=!1;""===f?(f=window.tdcAdminSettings.headerTemplateId.toString().replace("tdb_template_",""),d=window.tdcAdminSettings.headerTemplateContent,e=!0):"no_header"===f&&(a=!0);if(""!==d){var k=JSON.parse(tdcUtil.b64DecodeUnicode(d));b.isUndefined(k.tdc_is_header_sticky)||!0!==k.tdc_is_header_sticky||tdcState.setHeaderSticky();
b.isUndefined(k.tdc_is_mobile_header_sticky)||!0!==k.tdc_is_mobile_header_sticky||tdcState.setMobileHeaderSticky()}""===c?(c=window.tdcAdminSettings.footerTemplateId.toString().replace("tdb_template_",""),m=window.tdcAdminSettings.footerTemplateContent,g=!0):"no_footer"===c&&(l=!0);tdcState.init(f,d,e,a,c,m,g,l)})(jQuery,Backbone,_);var tdcSavePost;
...
data:tdcLivePanel.$panel.serialize()}).done(function(a,e,g){window.tdcPostSettings.postContent=tdcUtil.b64EncodeUnicode(tdcSavePost.content);f(".tdc-save-page").removeClass("tdc-saving-loader");"success"===e&&(b.isObject(a)&&b.has(a,"errors")?new tdcNotice.notice(a.errors,!0,!1):(new tdcNotice.notice("Content Successfully Saved!",!1,!0),0!==tdcLivePanel.$tdbPostSettings.length&&!0===tdcLivePanel.$tdbPostSettings.data("changed")&&new tdcNotice.notice("Single Templates Post Settings Successfully Saved!",
...
tdc_post_id:tdcLivePanel.$tdcPostId.val()}}).done(function(a,e,g){window.tdcPostSettings.postContent=tdcUtil.b64EncodeUnicode(tdcSavePost.content);f(".tdc-save-page").removeClass("tdc-saving-loader");"success"===e&&b.isObject(a)&&(b.has(a,"errors")?new tdcNotice.notice(a.errors,!0,!1):(b.has(a,"header_template_id")&&(tdcState.setHeaderTemplateId(a.header_template_id),tdcSidebar.updateHeaderTemplates()),tdcMain.resetContentModified(),new tdcNotice.notice("Header Successfully Saved!",!1,!0)))}).fail(function(a,
b,e){}))},getHeaderTemplateData:function(){var a=tdcState.getHeaderTemplateId(),c="",b={};""!==a&&"no_header"!==a&&(c=tdcUtil.b64EncodeUnicode(JSON.stringify(tdcIFrameData.getHeaderShortcodeFromData())));tdcState.setHeaderTemplateId(a);tdcState.setHeaderTemplateContent(c);b.tdc_header_template_id=a;b.tdc_header_template_content=c;b.tdc_assoc_header_template=tdcState.isGlobalTemplate()?"":!0;return b},cloudLoadHeaderTemplate:function(a,c,e,g){b.isUndefined(a)||(g={td_magic_token:tdcLivePanel.$token.val(),
tdc_action:"load_header_template",tdc_header_template_content:a,tdc_header_template_title:g},b.isUndefined(e)||(g.tdc_header_template_id=e),f.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/load_header_template","uuid="+tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},data:g}).done(function(e,m,g){"success"===m&&b.isObject(e)&&(b.has(e,"errors")?new tdcNotice.notice(e.errors,!0,!1):b.has(e,"header_template_id")&&
(tdcState.setHeaderTemplateId(e.header_template_id),tdcState.unsetGlobalTemplate()),tdcSidebar.updateHeaderTemplates(),tdcIFrameData.setHeaderTemplate(a,c))}).fail(function(a,c,b){}))},cloudLoadFooterTemplate:function(a,c,e,g){b.isUndefined(a)||(g={td_magic_token:tdcLivePanel.$token.val(),tdc_action:"load_footer_template",tdc_footer_template_content:a,tdc_footer_template_title:g},b.isUndefined(e)||(g.tdc_footer_template_id=e),f.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/load_footer_template",
"uuid="+tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},data:g}).done(function(e,m,g){"success"===m&&b.isObject(e)&&(b.has(e,"errors")?new tdcNotice.notice(e.errors,!0,!1):b.has(e,"footer_template_id")&&(tdcState.setFooterTemplateId(e.footer_template_id),tdcState.unsetGlobalFooterTemplate()),tdcSidebar.updateFooterTemplates(),tdcIFrameData.setFooterTemplate(a,c))}).fail(function(a,c,b){}))},getFooterTemplateData:function(){var a=
...
wasElementDragged:k,wasInnerColumnDragged:h,wasInnerRowDragged:n,wasTempInnerRowDragged:p,wasColumnDragged:q,wasRowDragged:t,wasTempRowDragged:v,wasElementWithRowDragged:u,rowStartValues:r,draggedBlockUid:A,sourceColParam:g});tdcSidebarPanel.clearPanel();tdcOperationUI.setDraggedElement(e);tdcOperationUI.setCurrentElementOver(e);tb_remove()},e,"Are you sure you want to delete this element?");return}if(-1===y&&1===z.length||2===z.length&&-1!==y){c="";var B=a.closest(".tdc-inner-column");if(B.length)c=
...
a.data("shortcodeName")),b.isUndefined(a.data("startValues"))||c.data("startValues",a.data("startValues")),b.isUndefined(a.data("shortcodeContent"))||c.data("shortcodeContent",a.data("shortcodeContent")),b.isUndefined(a.data("rowStartValues"))||c.data("rowStartValues",a.data("rowStartValues")),b.isUndefined(a.data("templateContent"))||c.data("templateContent",a.data("templateContent")),tdcOperationUI.setDraggedElement(c),a=tdcOperationUI.getDraggedElement());m.replaceWith(a);if(d||k)B=a.closest(".tdc-inner-column"),
B.length?(a.removeClass("tdc-element-column"),a.addClass("tdc-element-inner-column")):(C=a.closest(".tdc-column"),C.length&&(a.removeClass("tdc-element-inner-column"),a.addClass("tdc-element-column")));m=a.prev();m.hasClass(tdcOperationUI._emptyElementClass)&&m.remove();m=a.next();m.hasClass(tdcOperationUI._emptyElementClass)&&m.remove();tdcIFrameData.changeData({$refEl:tdcOperationUI.getDraggedElement(),wasSidebarElementDragged:d,wasElementDragged:k,wasInnerColumnDragged:h,wasInnerRowDragged:n,wasTempInnerRowDragged:p,
wasColumnDragged:q,wasRowDragged:t,wasTempRowDragged:v,wasElementWithRowDragged:u,draggedBlockUid:A,sourceColParam:g})}else new tdcNotice.notice("_moveDraggedElement Error: $draggedElement not valid!",!0,!1)}},_copyElement:function(a){var c=tdcOperationUI.getCurrentElementOver(),m=tdcAdminWrapperUI.$placeholder;if(!b.isUndefined(c)&&!b.isUndefined(m)){var g=tdcUtil.getStorageItem("copyShortcodeType"),d=tdcUtil.getStorageItem("copyShortcodeAttrs"),k=tdcUtil.getStorageItem("copySourceCol"),h=tdcUtil.getStorageItem("copyShortcode"),
n=!1,p=!1,q=!1,t=!1,v=!1,u="",r=f('<div class="tdc-dropped"></div>');"vc_row"===g?(u="tdc-row",v=!0,r.addClass("tdc-row-temp")):"vc_column"===g?(u="tdc-element-column",q=!0):"vc_row_inner"===g?(u="tdc-element-inner-row",t=!0,r.addClass("tdc-element-inner-row-temp")):"vc_column_inner"===g?(u="tdc-element-inner-column",p=!0):""!==g&&(u="tdc-element",n=!0);r.addClass(u);r.data("shortcodeName",g);r.data("startValues",d);if(v||t)r.data("templateContent",h);else if(q||p){c=c.data("model_id");var w="";g=
tdcIFrameData.getModel(c).get("childCollection");b.isUndefined(g)||b.map(g.models,function(a,c){var m={error:e,getShortcode:""};tdcIFrameData._checkModelData(a,m);b.isUndefined(m.getShortcode)||(w+=m.getShortcode)});g="";g=b.isUndefined(a)||!0!==a?tdcUtil.b64EncodeUnicode(tdcUtil.b64DecodeUnicode(h)+w):tdcUtil.b64EncodeUnicode(w+tdcUtil.b64DecodeUnicode(h));r.data("templateContent",g);r.data("model_id",c)}m.replaceWith(r);r.closest(".tdc-inner-columns").length?r.addClass("tdc-element-inner-column"):
r.closest(".tdc-columns").length&&r.addClass("tdc-element-column");tdcIFrameData.changeData({$refEl:r,wasSidebarElementDragged:!0,wasElementDragged:n,wasInnerColumnDragged:p,wasInnerRowDragged:!1,wasTempInnerRowDragged:t,wasColumnDragged:q,wasRowDragged:!1,wasTempRowDragged:v,wasElementWithRowDragged:!1,draggedBlockUid:"",sourceColParam:k})}}}})(jQuery,Backbone,_);var tdcZoneUI;
...
else if("scroll"===a.type){g=tdcOperationUI.iframeContents.scrollLeft()+window.previousMouseClientX;d=tdcOperationUI.iframeContents.scrollTop()+window.previousMouseClientY;var k={pageX:g,pageY:d};tdcOperationUI.setCurrentElementOver(e);tdcRowUI.tdcRow.each(function(a,c){b.isUndefined(tdcOperationUI.getCurrentElementOver())&&f(c).trigger(f.Event("fakemouseenterevent",k))});return}g=tdcOperationUI.getCurrentElementOver();if(b.isUndefined(tdcOperationUI.getDraggedElement())||b.isUndefined(g))tdcOperationUI.hidePlaceholder();
else{var h=tdcOperationUI.getCurrentElementOverOuterHeight(),n=tdcOperationUI.getCurrentElementOverOuterWidth(),p=tdcOperationUI.getCurrentElementOverOffset();if(d>p.top+h/2){d=g.next();if(!d.length||d.length&&d.attr("id")!==tdcAdminWrapperUI.placeholderId)g.after(m),tdcOperationUI.updateInfoHelper();parseInt(p.top)+parseInt(h)>parseInt(tdcOperationUI.iframeContents.scrollTop())+parseInt(window.innerHeight)?tdcOperationUI.setHorizontalPlaceholder({position:"fixed",top:"",left:"",right:"auto",bottom:"0",
width:n,"margin-left":""}):tdcOperationUI.setHorizontalPlaceholder({position:"absolute",top:"",left:"",right:"",bottom:"",width:n,"margin-left":""})}else{d=g.prev();if(!d.length||d.length&&d.attr("id")!==tdcAdminWrapperUI.placeholderId)g.before(m),tdcOperationUI.updateInfoHelper();parseInt(p.top)<parseInt(tdcOperationUI.iframeContents.scrollTop())?tdcOperationUI.setHorizontalPlaceholder({position:"fixed",top:"0",left:"",right:"auto",bottom:"",width:n,"margin-left":""}):tdcOperationUI.setHorizontalPlaceholder({position:"absolute",
top:"",left:"",right:"",bottom:"",width:n,"margin-left":""})}b.isUndefined(c)||!0!==c?tdcOperationUI.showPlaceholder():tdcOperationUI.hidePlaceholder()}},getElementCssClass:function(){return tdcRowUI._elementCssClass}}})(jQuery,Backbone,_);var tdcColumnUI;
...
k+=d.left;parseInt(k)<=parseInt(c.pageX)&&parseInt(c.pageX)<=parseInt(k+b)&&parseInt(d.top)<=parseInt(c.pageY)&&parseInt(c.pageY)<=parseInt(d.top+e)&&(tdcOperationUI.setCurrentElementOver(a),tdcColumnUI.positionColumnPlaceholder(c))}}}).on("contextmousedown",function(c){c.preventDefault();c.stopPropagation();tdcContextMenu.setContextMenu(c,a)&&(tdcSidebar.setSettings({$currentZone:tdcOperationUI.inZone(a),$currentRow:tdcOperationUI.inRow(a),$currentColumn:tdcOperationUI.inColumn(a)}),tdcOperationUI.activeElementOver(a))})},
positionColumnPlaceholder:function(a,c){var m=tdcAdminWrapperUI.$placeholder,g=0,d=0;if("mousedown"===a.type||"mousemove"===a.type||"fakemouseenterevent"===a.type)g=a.pageX,d=a.pageY,b.isUndefined(a.clientX)||b.isUndefined(a.clientY)||(window.previousMouseClientX=a.clientX,window.previousMouseClientY=a.clientY);else if("scroll"===a.type){g=tdcOperationUI.iframeContents.scrollLeft()+window.previousMouseClientX;d=tdcOperationUI.iframeContents.scrollTop()+window.previousMouseClientY;var k={pageX:g,pageY:d};
tdcOperationUI.setCurrentElementOver(e);tdcOperationUI.getDraggedElement().closest(".tdc-columns").find(".tdc-column").each(function(a,c){b.isUndefined(tdcOperationUI.getCurrentElementOver())&&f(c).trigger(f.Event("fakemouseenterevent",k))});return}d=tdcOperationUI.getCurrentElementOver();if(b.isUndefined(tdcOperationUI.getDraggedElement())||b.isUndefined(d))tdcOperationUI.hidePlaceholder();else{var h=d.outerWidth(!0),n=tdcOperationUI.getCurrentElementOverOffset(),p=0,q=d.prevAll();q.length&&q.each(function(a,
c){var b=f(c);b.hasClass("tdc-column")&&(p+=parseInt(b.outerWidth(!0)))});q=d.parent(".tdc-columns").parent(".vc_row");var t=q.css("position");if(b.isUndefined(t)||"static"!==t)if(q=q.css("padding-left"),b.isUndefined(q)||(q=parseInt(q.replace("px",""))),g>n.left+h/2){g=d.next();if(!g.length||g.length&&g.attr("id")!==tdcAdminWrapperUI.placeholderId)d.after(m),tdcOperationUI.updateInfoHelper();tdcOperationUI.setVerticalPlaceholder({left:parseInt(p+h+q),"margin-left":-24,top:""})}else{g=d.prev();if(!g.length||
g.length&&g.attr("id")!==tdcAdminWrapperUI.placeholderId)d.before(m),tdcOperationUI.updateInfoHelper();tdcOperationUI.setVerticalPlaceholder({left:parseInt(p+q),"margin-left":-24,top:""})}else if(g>n.left+h/2){g=d.next();if(!g.length||g.length&&g.attr("id")!==tdcAdminWrapperUI.placeholderId)d.after(m),tdcOperationUI.updateInfoHelper();tdcOperationUI.setVerticalPlaceholder({left:parseInt(n.left+h),"margin-left":-24,top:""})}else{g=d.prev();if(!g.length||g.length&&g.attr("id")!==tdcAdminWrapperUI.placeholderId)d.before(m),
tdcOperationUI.updateInfoHelper();tdcOperationUI.setVerticalPlaceholder({left:parseInt(n.left),"margin-left":-24,top:""})}b.isUndefined(c)||!0!==c?tdcOperationUI.showPlaceholder():tdcOperationUI.hidePlaceholder()}},getElementCssClass:function(){return tdcColumnUI._elementCssClass}}})(jQuery,Backbone,_);var tdcInnerRowUI;
...
$currentRow:tdcOperationUI.inRow(a),$currentColumn:tdcOperationUI.inColumn(a),$currentInnerRow:tdcOperationUI.inInnerRow(a)}),tdcOperationUI.activeElementOver(a))})},positionInnerRowPlaceholder:function(a,c){var m=tdcAdminWrapperUI.$placeholder,d=0,l=0;if("mousedown"===a.type||"mousemove"===a.type||"fakemouseenterevent"===a.type)d=a.pageX,l=a.pageY,b.isUndefined(a.clientX)||b.isUndefined(a.clientY)||(window.previousMouseClientX=a.clientX,window.previousMouseClientY=a.clientY);else if("scroll"===a.type){d=
tdcOperationUI.iframeContents.scrollLeft()+window.previousMouseClientX;l=tdcOperationUI.iframeContents.scrollTop()+window.previousMouseClientY;var k={pageX:d,pageY:l};tdcOperationUI.setCurrentElementOver(e);tdcElementUI.tdcElement.each(function(a,c){b.isUndefined(tdcOperationUI.getCurrentElementOver())&&f(c).trigger(f.Event("fakemouseenterevent",k))});tdcInnerRowUI.tdcElementInnerRow.each(function(a,c){b.isUndefined(tdcOperationUI.getCurrentElementOver())&&f(c).trigger(f.Event("fakemouseenterevent",
k))});return}d=tdcOperationUI.getCurrentElementOver();if(b.isUndefined(tdcOperationUI.getDraggedElement())||b.isUndefined(d))tdcOperationUI.hidePlaceholder();else{var h=d.outerHeight(!0),n=d.innerWidth(),p=d.offset();if(l>p.top+h/2){l=d.next();if(!l.length||l.length&&l.attr("id")!==tdcAdminWrapperUI.placeholderId)d.after(m),tdcOperationUI.updateInfoHelper(e);parseInt(p.top)+parseInt(h)>parseInt(tdcOperationUI.iframeContents.scrollTop())+parseInt(window.innerHeight)?tdcOperationUI.setHorizontalPlaceholder({position:"fixed",
top:"",left:"","margin-top":"","margin-left":"",bottom:"0",width:n}):tdcOperationUI.setHorizontalPlaceholder({position:"absolute",top:"",left:"","margin-top":"","margin-left":"",bottom:"",width:n})}else{l=d.prev();if(!l.length||l.length&&l.attr("id")!==tdcAdminWrapperUI.placeholderId)d.before(m),tdcOperationUI.updateInfoHelper(e);parseInt(p.top)<parseInt(tdcOperationUI.iframeContents.scrollTop())?tdcOperationUI.setHorizontalPlaceholder({position:"fixed",top:"0",left:"","margin-top":"0","margin-left":"",
bottom:"",width:n}):tdcOperationUI.setHorizontalPlaceholder({position:"absolute",top:"",left:"","margin-top":"","margin-left":"",bottom:"",width:n})}b.isUndefined(c)||!0!==c?tdcOperationUI.showPlaceholder():tdcOperationUI.hidePlaceholder()}},getElementCssClass:function(){return tdcInnerRowUI._elementCssClass}}})(jQuery,Backbone,_);var tdcInnerColumnUI;
...
b.isUndefined(d.elementOuterWidth)||(h=d.elementOuterWidth),parseInt(n.top)+parseInt(p)>parseInt(tdcOperationUI.iframeContents.scrollTop())+parseInt(window.innerHeight)?(n=parseInt(n.left),d.isInnerColumnLastElement&&(l=l.closest(".tdc-element-inner-row"),n=parseInt(l.offset().left)-parseInt(l.css("margin-left"))),tdcOperationUI.setHorizontalPlaceholder({position:"fixed",top:"",left:n,"margin-top":"","margin-left":"",bottom:"0",width:h})):(n=parseInt(k.left),d.isInnerColumnLastElement&&(l=l.closest(".tdc-element-inner-row"),
n=parseInt(l.position().left)+parseInt(l.css("margin-left"))),tdcOperationUI.setHorizontalPlaceholder({position:"absolute",top:k.top+q+p,left:n,"margin-top":"","margin-left":"",bottom:"",width:h}))):(d=tdcElementUI._checkInnerColumnFirstElement(d),b.isUndefined(d.elementOuterWidth)||(h=d.elementOuterWidth),parseInt(n.top)<parseInt(tdcOperationUI.iframeContents.scrollTop())?(n=parseInt(n.left)-parseInt(l.css("margin-left")),tdcOperationUI.setHorizontalPlaceholder({position:"fixed",top:"0",left:n,"margin-top":"0",
"margin-left":"",bottom:"",width:h})):(n=parseInt(k.left),tdcOperationUI.setHorizontalPlaceholder({position:"absolute",top:k.top+q,left:n,"margin-top":"","margin-left":"",bottom:"",width:h})))):d.Y>n.top+p/2?(d=tdcElementUI._checkInnerColumnLastElement(d),b.isUndefined(d.elementOuterWidth)||(h=d.elementOuterWidth),parseInt(n.top)+parseInt(k)>parseInt(tdcOperationUI.iframeContents.scrollTop())+parseInt(window.innerHeight)?tdcOperationUI.setHorizontalPlaceholder({position:"fixed",top:"",left:"","margin-top":"",
"margin-left":"",bottom:"0",width:h}):tdcOperationUI.setHorizontalPlaceholder({position:"absolute",top:"",left:"","margin-top":"","margin-left":"",bottom:"",width:h})):(d=tdcElementUI._checkInnerColumnFirstElement(d),b.isUndefined(d.elementOuterWidth)||(h=d.elementOuterWidth),parseInt(n.top)<parseInt(tdcOperationUI.iframeContents.scrollTop())?tdcOperationUI.setHorizontalPlaceholder({position:"fixed",top:"0",left:"","margin-top":"0","margin-left":"",bottom:"",width:h}):tdcOperationUI.setHorizontalPlaceholder({position:"absolute",
...
tdcMaskUI.$content.hide(),tdcMaskUI.$contentFull.hide();else{a=tdcMaskUI.$currentElement.closest(".tdc-zone").offset();var c=tdcMaskUI.$currentElement.offset(),e=tdcMaskUI.$currentElement.outerWidth(),d=tdcMaskUI.$currentElement.outerWidth(!0),l=tdcMaskUI.$currentElement.outerHeight(),k=tdcMaskUI.$currentElement.outerHeight(!0),h=tdcMaskUI.$currentElement.css("margin-top"),f=tdcMaskUI.$currentElement.css("margin-left");12>Math.abs(a.top-c.top)?tdcMaskUI.$wrapper.addClass("tdc-mask-top"):tdcMaskUI.$wrapper.removeClass("tdc-mask-top");
tdcMaskUI.$wrapper.css({top:c.top,left:c.left,width:e,height:l});tdcMaskUI.$content.css({top:c.top,left:c.left,width:e,height:l});tdcMaskUI.$contentFull.css({top:c.top-parseFloat(h),left:c.left-parseFloat(f),width:d,height:k});tdcMaskUI.$content.removeAttr("class");tdcMaskUI.$wrapper.show();tdcMaskUI.$content.show();tdcMaskUI.$contentFull.show();tdcMaskUI.setHandlers();a=tdcMaskUI.$currentElement.data("model_id");b.isUndefined(a)||(a=tdcIFrameData.getModel(a),c=a.get("attrs"),b.has(c,"custom_title")?
...
!0,!1);else{a=tdcIFrameData.getModel(a);var c=a.get("parentModel"),d=c.get("childCollection");if(b.isUndefined(a))new tdcNotice.notice("tdcRowHandlerUI -> tdcRowHandlerUI._$handlerClone Error: Element model not in structure data!",!0,!1);else{tdcOperationUI.setDraggedElement(f('<div class="tdc-row">Cloned row</div>'));var l=tdcOperationUI.getDraggedElement();l.insertAfter(tdcRowHandlerUI.$elementRow);tdcRowUI.bindRow(l);var k=l.prevAll(".tdc-row").length;c=new tdcIFrameData.TdcModel({content:"",attrs:b.clone(a.get("attrs")),
tag:"vc_row",type:"closed",level:1,parentModel:c});new tdcIFrameData.TdcLiveView({model:c,el:l[0]});var h=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_column",type:"closed",level:2,parentModel:c});l.data("model_id",c.cid);d.add(c,{at:k});d=new tdcIFrameData.TdcCollection;d.add(h);c.set("childCollection",d);h.set("childCollection",new tdcIFrameData.TdcCollection);c.getShortcodeRender(3,"",!0,a);tdcOperationUI.setDraggedElement(e);tb_remove()}}},[a],"Are you sure you want to clone the current row and all its elements?"),
...
!0,!1);else{tdcOperationUI.setDraggedElement(f('<div class="tdc-element-column tdc-element-inner-row">Cloned Inner Row</div>'));var c=tdcOperationUI.getDraggedElement();c.insertAfter(tdcInnerRowHandlerUI.$elementInnerRow);tdcInnerRowUI.bindInnerRow(c);var d=c.prevAll(".tdc-element-column").length,l=new tdcIFrameData.TdcModel({content:"",attrs:b.clone(a.get("attrs")),tag:"vc_row_inner",type:"closed",level:2,parentModel:a.get("parentModel")});new tdcIFrameData.TdcLiveView({model:l,el:c[0]});var k=new tdcIFrameData.TdcModel({content:"",
attrs:{},tag:"vc_column_inner",type:"closed",level:3,parentModel:l});c.data("model_id",l.cid);a.get("parentModel").get("childCollection").add(l,{at:d});c=new tdcIFrameData.TdcCollection;c.add(k);l.set("childCollection",c);c=new tdcIFrameData.TdcCollection;k.set("childCollection",c);k=tdcIFrameData._getDestinationCol(tdcOperationUI.getDraggedElement());l.getShortcodeRender(k,"",!0,a);tdcOperationUI.setDraggedElement(e);tb_remove()}},[a],"Are you sure you want to clone the current inner row and all its elements?")},
...
(function(f,d,b,e){tdcIFrameData={iframeContents:e,tdcTopCollection:e,TdcModel:e,TdcCollection:e,TdcLiveView:e,_postOriginalContentJSON:e,_shortcodeParserSettingsClone:e,_isInitialized:!1,init:function(a,c){b.isUndefined(c)||!0!==c||(tdcIFrameData._isInitialized=!1);if(!tdcIFrameData._isInitialized&&(tdcIFrameData.iframeContents=a,tdcIFrameData._defineStructuredData(),!0===tdcIFrameData._initStructuredData())){var e={};tdcIFrameData.bindViewsModelsWrappers(e,tdcIFrameData.tdcTopCollection,tdcIFrameData.iframeContents);
if(!b.isEmpty(e)){for(var d in e)tdcDebug.log(e[d]);var l='The model does not match the <a href="'+a.attr("URL")+'" target="_blank">content</a>';b.isUndefined(e[d].info)||(l=e[d].info+". "+l);new tdcNotice.notice(l,!0,!1)}tdcDebug.log(tdcIFrameData.tdcTopCollection.models);""===tdcState.getHeaderTemplateId()?(tdcSidebar.$_headerTemplateZones.hide(),tdcSidebar.$_sidebar.find(".tdu-save-header-template").hide()):"no_header"===tdcState.getHeaderTemplateId()?(tdcSidebar.$_headerTemplateZones.hide(),tdcSidebar.$_sidebar.find(".tdu-save-header-template").hide()):
(tdcSidebar.$_headerTemplateZones.show(),tdcSidebar.$_sidebar.find(".tdu-save-header-template").show());tdcIFrameData.addDummyContent();tdcIFrameData._isInitialized=!0;tdcRecycle.init()}},activateZone:function(a,c,d){tdcIFrameData.iframeContents.find(".tdc-zone").each(function(g){g=f(this);if(g.data("type")===a){var m=g.data("model_id");if(!b.isUndefined(m)&&(m=tdcIFrameData.getModel(m),!b.isUndefined(m))){var k=m.get("blockUid");if(!b.isUndefined(k)){var h=tdcAdminIFrameUI.getLiveIframe(),n=h.contents().find("#"+
k);n.length||(n=h.contents().find('[data-td-block-uid="'+k+'"]'));n.length&&(k={},tdcOperationUI.inRow(n)?tdcOperationUI.inRow(n)?tdcOperationUI.inColumn(n)?tdcOperationUI.inInnerRow(n)?tdcOperationUI.inInnerColumn(n)?(k.$currentZone=tdcOperationUI.inZone(n),k.$currentRow=tdcOperationUI.inRow(n),k.$currentColumn=tdcOperationUI.inColumn(n),k.$currentInnerRow=tdcOperationUI.inInnerRow(n),k.$currentInnerColumn=tdcOperationUI.inInnerColumn(n),k.$currentElement=n):(k.$currentZone=tdcOperationUI.inZone(n),
k.$currentRow=tdcOperationUI.inRow(n),k.$currentColumn=tdcOperationUI.inColumn(n),k.$currentInnerRow=tdcOperationUI.inInnerRow(n),k.$currentInnerColumn=n):(k.$currentZone=tdcOperationUI.inZone(n),k.$currentRow=tdcOperationUI.inRow(n),k.$currentColumn=tdcOperationUI.inColumn(n),k.$currentInnerRow=n):(k.$currentZone=tdcOperationUI.inZone(n),k.$currentRow=tdcOperationUI.inRow(n),k.$currentColumn=n):(k.$currentZone=tdcOperationUI.inZone(n),k.$currentRow=n):k.$currentZone=n,tdcSidebar._currentModel=m,
n.data("model_id",m.cid),tdcSidebar.setSettings(k,!0,m),tdcSidebar.$_sidebar.find(".tdc-responsive-buttons > .tdc-responsive-phone").trigger("click"),0<a.indexOf("sticky")?(0<a.indexOf("mobile")?tdcSidebar.$_sidebar.find(".tdc-responsive-buttons > .tdc-responsive-phone").trigger("click"):"phone"===tdcSidebar.currentViewportSettings.name&&tdcSidebar.$_sidebar.find(".tdc-responsive-buttons > .tdc-responsive-all").trigger("click"),b.isUndefined(c)||(!0===c?(tdcSidebar.setForcedHeaderZone(a),g.parent().addClass("tdc-zone-sticky-active"),
g.parent().removeClass("tdc-zone-sticky-inactive"),g.parent().removeClass("tdc-zone-sticky-invisible"),b.isUndefined(d)||!0!==d||(setTimeout(function(){tdcIFrameData.addDummyContent()},100),setTimeout(function(){tdcIFrameData.iframeContents.scrollTop(tdcAdminIFrameUI.getIframeWindow().tdHeader.getFixedHeaderHeight()+210)},150),setTimeout(function(){tdcIFrameData.iframeContents.scrollTop(tdcAdminIFrameUI.getIframeWindow().tdHeader.getFixedHeaderHeight()+209)},200))):(g.parent().removeClass("tdc-zone-sticky-active"),
g.parent().addClass("tdc-zone-sticky-inactive"),g.parent().addClass("tdc-zone-sticky-invisible")))):(0<a.indexOf("mobile")?tdcSidebar.$_sidebar.find(".tdc-responsive-buttons > .tdc-responsive-phone").trigger("click"):"phone"===tdcSidebar.currentViewportSettings.name&&tdcSidebar.$_sidebar.find(".tdc-responsive-buttons > .tdc-responsive-all").trigger("click"),tdcSidebar.setForcedHeaderZone(e),b.isUndefined(d)||!0!==d||(setTimeout(function(){tdcIFrameData.addDummyContent()},100),setTimeout(function(){tdcIFrameData.iframeContents.scrollTop(0)},
200))))}}}})},addDummyContent:function(){tdcIFrameData.iframeContents.find(".tdc-zone").each(function(a){if("tdc_content"===f(this).data("type")){a=tdcIFrameData.iframeContents.find(".tdc-dummy-content");var c=tdcIFrameData.iframeContents.contents().find("body"),b=c.height()-tdcAdminIFrameUI.getIframeWindow().innerHeight,e=0;a.length&&a.remove();0>b?e=Math.abs(b)+tdcIFrameData.iframeContents.contents().find(".td-main-content-wrap").offset().top+300:5>c.height()-tdcAdminIFrameUI.getIframeWindow().innerHeight-
tdcIFrameData.iframeContents.contents().find(".td-main-content-wrap").offset().top&&(e=tdcAdminIFrameUI.getIframeWindow().innerHeight-c.height()+tdcIFrameData.iframeContents.contents().find(".td-main-content-wrap").offset().top+300);c.append('<div class="tdc-dummy-content" style="height:'+e+'px"></div>')}})},rebuildZone:function(a,c,d,g){var m=tdcIFrameData.getFirstModelByZoneType(a);if(!b.isUndefined(m)){var k=m.get("blockUid");tdcIFrameData.removeModel(m,!0,{silent:!0});m=tdcIFrameData._getOriginalContentJSON(c);
if(b.isUndefined(m)||""===m)m=[{child:[tdcShortcodeParser.parse(0,'[tdc_zone type="'+a+'"][vc_row][vc_column][/vc_column][/vc_row][/tdc_zone]')[0].child[0]],index:0,content:'[tdc_zone type="'+a+'"][vc_row][vc_column][/vc_column][/vc_row][/tdc_zone]',shortcode:{tag:"tdc_zone",type:"closed",attrs:{named:{type:a}},content:"[vc_row][vc_column][/vc_column][/vc_row]"}}];if(tdcIFrameData._initComponentData(a,m,!0)){m=tdcIFrameData.getFirstModelByZoneType(a);a=tdcIFrameData.iframeContents.find("#"+k);if(!a.length)return!1;
c=a.get(0);a.data("model_id",m.cid);m.set("blockUid",k);m.set("html",c.innerHTML);new tdcIFrameData.TdcLiveView({model:m,el:c});b.isUndefined(d)||tdcIFrameData._checkModelData(m,{error:e,getShortcode:"",newImages:d});m.getShortcodeRender(3,k,!0,e,g)}return!0}return!1},setHeaderTemplate:function(a,c,d){if(""===a)tdcState.isNoHeader()?tdcIFrameData.iframeContents.find(".tdc-header-wrap").addClass("tdc-zone-invisible"):tdcIFrameData.iframeContents.find(".tdc-header-wrap").removeClass("tdc-zone-invisible"),
tdcIFrameData.iframeContents.find(".td-header-desktop-wrap, .td-header-desktop-sticky-wrap, .td-header-mobile-wrap, .td-header-mobile-sticky-wrap").addClass("tdc-zone-invisible"),tdcSidebar.$_headerTemplateZones.hide(),tdcSidebar.$_sidebar.find(".tdu-save-header-template").hide(),b.isUndefined(d)||b.isUndefined(d.is_snapshot)||!d.is_snapshot?(tdcRecycle.init(),tdcRecycle.takeSnapshot()):"Newspaper"===window.tdcAdminSettings.themeName&&["tdc_header_desktop","tdc_header_desktop_sticky","tdc_header_mobile",
"tdc_header_mobile_sticky"].forEach(function(a,c){var g;b.isUndefined(d)||(g=JSON.parse(JSON.stringify(d)));"tdc_header_mobile_sticky"!==a||b.isUndefined(d)||b.isUndefined(d.is_snapshot)||!d.is_snapshot||(b.isUndefined(g)&&(g={}),g.lateCallback=function(){var a=f(tdcAdminIFrameUI._$liveIframe).contents();tdcIFrameData.init(a,!0);tdcRecycle.clearJsItems();tdcOperationUI.init(a);b.isUndefined(g.indexPath)||tdcSidebarPanel.showShortcodeFromPath(g.indexPath)});tdcIFrameData.rebuildZone(a,"[tdc_zone][vc_row][vc_column][/vc_column][/vc_row][/tdc_zone]",
e,g)});else{var g=JSON.parse(tdcUtil.b64DecodeUnicode(a));tdcIFrameData.iframeContents.find(".tdc-header-wrap").addClass("tdc-zone-invisible");tdcIFrameData.iframeContents.find(".td-header-desktop-wrap, .td-header-desktop-sticky-wrap, .td-header-mobile-wrap, .td-header-mobile-sticky-wrap").removeClass("tdc-zone-invisible");tdcSidebar.$_headerTemplateZones.show();tdcSidebar.$_sidebar.find(".tdu-save-header-template").show();"Newspaper"===window.tdcAdminSettings.themeName&&["tdc_header_desktop","tdc_header_desktop_sticky",
"tdc_header_mobile","tdc_header_mobile_sticky"].forEach(function(a,e){if(g.hasOwnProperty(a)){if(!b.isUndefined(d))var m=JSON.parse(JSON.stringify(d));"tdc_header_mobile_sticky"!==a||b.isUndefined(d)||b.isUndefined(d.is_snapshot)||!d.is_snapshot||(b.isUndefined(m)&&(m={}),m.lateCallback=function(){var a=f(tdcAdminIFrameUI._$liveIframe).contents();tdcIFrameData.init(a,!0);tdcRecycle.clearJsItems();tdcOperationUI.init(a);b.has(d,"data")&&b.has(data,"replyJsForEval")&&tdcAdminIFrameUI.evalInIframe(d.data.replyJsForEval);
b.isUndefined(m.indexPath)||tdcSidebarPanel.showShortcodeFromPath(m.indexPath)});tdcIFrameData.rebuildZone(a,g[a],c,m)}});"header"===window.tdcPostSettings.tdbTemplateType&&tdcSavePost.updateHeaderTemplate()}},setFooterTemplate:function(a,c,d){if(""===a)if(tdcState.isNoFooter()?tdcIFrameData.iframeContents.find(".tdc-footer-wrap").addClass("tdc-zone-invisible"):tdcIFrameData.iframeContents.find(".tdc-footer-wrap").removeClass("tdc-zone-invisible"),tdcIFrameData.iframeContents.find(".td-footer-wrap").addClass("tdc-zone-invisible"),
tdcSidebar.$_sidebar.find(".tdu-save-footer-template").hide(),b.isUndefined(d)||b.isUndefined(d.is_snapshot)||!d.is_snapshot)tdcRecycle.init(),tdcRecycle.takeSnapshot();else{if("Newspaper"===window.tdcAdminSettings.themeName){if(!b.isUndefined(d))var g=JSON.parse(JSON.stringify(d));tdcIFrameData.rebuildZone("tdc_footer","[tdc_zone][vc_row][vc_column][/vc_column][/vc_row][/tdc_zone]",e,g)}}else tdcIFrameData.iframeContents.find(".tdc-footer-wrap").addClass("tdc-zone-invisible"),tdcIFrameData.iframeContents.find(".td-footer-wrap").removeClass("tdc-zone-invisible"),
tdcSidebar.$_sidebar.find(".tdu-save-footer-template").show(),"Newspaper"===window.tdcAdminSettings.themeName&&(b.isUndefined(d)||(g=JSON.parse(JSON.stringify(d))),tdcIFrameData.rebuildZone("tdc_footer",a,c,g)),"footer"===window.tdcPostSettings.tdbTemplateType&&tdcSavePost.updateFooterTemplate()},_callbackShortcodeRender:function(a){b.isUndefined(a)||b.isUndefined(a.lateCallback)||(b.isUndefined(a.lateCallbackContext)?setTimeout(function(){a.lateCallback.call(this)},2E3):setTimeout(function(){a.lateCallback.call(a.lateCallbackContext)},
2E3))},_defineStructuredData:function(){tdcIFrameData._isInitialized||(tdcIFrameData.TdcModel=Backbone.Model.extend({getShortcodeRender:function(a,c,d,g,l){var m=this,h={error:e,getShortcode:""};b.isUndefined(g)?tdcIFrameData._checkModelData(m,h):tdcIFrameData._checkModelData(g,h);if(!b.isUndefined(h.getShortcode)){var f=new tdcJobManager.job;f.shortcode=h.getShortcode;f.columns=a;f.blockUid=c;f.tries=0;f.success_callback=function(a){tdcDebug.log(a);var k=tdcAdminIFrameUI.getIframeWindow();b.isUndefined(g)&&
tdcIFrameData.deleteCallback(m);!1===d?m.set("blockUid",a.blockUid):m.set("blockUid",e);b.has(a,"replyHtml")&&(m.set("bindNewContent",d),m.set("shortcode",f.shortcode),m.set("html",a.replyHtml,l));b.has(a,"replyJsForEval")&&(k.tdcEvalGlobal={oldBlockUid:c},tdcAdminIFrameUI.evalInIframe(a.replyJsForEval));b.isUndefined(l)||b.isUndefined(l.earlyCallback)||(b.isUndefined(l.earlyCallbackContext)?l.earlyCallback.call(this):l.earlyCallback.call(l.earlyCallbackContext))};b.isUndefined(l)||b.isUndefined(l.is_snapshot)||
!0!==l.is_snapshot||(f.is_snapshot=!0);f.error_callback=function(a,c){tdcDebug.log(c);tdcDebug.log(a);f.tries||(f.tries++,tdcJobManager.addJob(f))};a=tdcOperationUI.getDraggedElement();b.isUndefined(a)||a.addClass("tdc-dropped");tdcJobManager.addJob(f)}h={error:e,getShortcode:""};tdcIFrameData._checkModelData(m,h);b.isUndefined(h.error)||tdcDebug.log(h.error);h={error:e,getShortcode:""};b.isUndefined(m.get("parentModel"))||(tdcIFrameData._checkModelData(m.get("parentModel"),h),b.isUndefined(h.error)||
tdcDebug.log(h.error))}}),tdcIFrameData.TdcCollection=Backbone.Collection.extend({model:tdcIFrameData.TdcModel}),tdcIFrameData.TdcTopCollection=Backbone.Collection.extend({model:tdcIFrameData.TdcModel}),tdcIFrameData.TdcLiveView=Backbone.View.extend({initialize:function(){this.listenTo(this.model,"change:current",this.changeCurrent);this.listenTo(this.model,"change:html",this.customRender);this.listenTo(this.model,"remove",this.customRemove)},changeCurrent:function(a,c,e){this.model.has("current")&&
!b.isUndefined(this.model.get("current"))&&!0===this.model.get("current")?(this.$el.addClass("tdc-element-selected"),tdcOperationUI.activeElementOver()):(this.$el.removeClass("tdc-element-selected"),tdcOperationUI.inactiveElementOver());this.model.set("cssWidth",this.$el.width())},customRemove:function(a,c,b){this.$el.hasClass("tdc-rows")?this.$el.html(""):this.remove()},customRender:function(a,c,d){tdcDebug.log("customRender - Rendering our model");if(this.model.has("html")&&!b.isUndefined(this.model.get("html"))){this.$el.removeClass("tdc-dropped");
this.$el.removeClass("tdc-changed");this.$el.hasClass("tdc_zone")?this.$el.html(this.$el.html()+this.model.get("html")):this.$el.html(this.model.get("html"));setTimeout(function(){"undefined"!==typeof tdcIFrameData.iframeContents.lastMouseEvent&&tdcMaskUI.repositionMask(tdcIFrameData.iframeContents.lastMouseEvent)},100);c=this.$el.find(".td_block_wrap");c.length&&0===parseInt(c.outerHeight(!0))&&c.addClass("tdc-block-empty");if(this.model.has("bindNewContent")&&!0===this.model.get("bindNewContent"))if(this.model.set("bindNewContent",
...
attrs:{named:{type:a}},content:"[vc_row][vc_column][/vc_column][/vc_row]"}}]});for(var l in c)if(c.hasOwnProperty(l)&&!tdcIFrameData._initComponentData(l,c[l]))return;return!0}},_initComponentData:function(a,c,d){if(!b.isUndefined(d)&&!1!==d||!tdcIFrameData._isInitialized){if(c.length){var g={};b.each(c,function(c,b,d){tdcIFrameData._getData(e,c,g,e,a)});b.isEmpty(g)||(console.log(c),tdcDebug.log(g),new tdcNotice.notice("Errors happened during _initStructureData() -> _getData()!",!0,!1));c={error:e,
...
(g="Not zones as the first elements!");!b.isUndefined(a)&&parseInt(a.get("level"),10)>=parseInt(f,10)&&(g="Elements does not respect the shortcode levels! ParentModel (cid: "+a.cid+" ) level: "+a.get("level")+" - element level : "+f);!b.isUndefined(a)&&2<parseInt(f,10)-parseInt(a.get("level"),10)&&3!==parseInt(a.get("level"),10)&&5!==parseInt(f,10)&&(g="Elements respect the shortcode levels, but the difference higher than 2 is not allowed here!");b.isUndefined(g)||(e[b.keys(e).length]={element:c,
info:g,parentModel:a});5!==parseInt(f,10)||b.isUndefined(c.shortcode.content)||(d=b.clone(c.shortcode.attrs.named),d.content=c.shortcode.content,c.shortcode.attrs.named=d);f={content:c.content,attrs:c.shortcode.attrs.named,tag:c.shortcode.tag,type:c.shortcode.type,level:parseInt(f,10),parentModel:a,bindNewContent:!1};b.isUndefined(l)||(f.type_zone=l);var p=new tdcIFrameData.TdcModel(f);b.has(c,"child")&&0<c.child.length&&(p.set("childCollection",new tdcIFrameData.TdcCollection),b.each(c.child,function(a,
...
l+h+"]";else switch(b.map(k,function(a,c){h+=" "+c+'="'+a+'"'}),d){case "single":h="["+l+h+"]";break;case "closed":p="";b.isUndefined(c["tempShortcodeDeepLevel"+(parseInt(c.deepLevel)+1)])||(p=c["tempShortcodeDeepLevel"+(parseInt(c.deepLevel)+1)],c["tempShortcodeDeepLevel"+(parseInt(c.deepLevel)+1)]=e);h="["+l+h+"]"+p+"[/"+l+"]";break;case "template":h="vc_column"===l||"vc_column_inner"===l?"["+l+h+"]"+c.template+"[/"+l+"]":c.template}c["tempShortcodeDeepLevel"+c.deepLevel]+=h;0===c.deepLevel&&(c.getShortcode+=
h)}}else c.error="Not zones as the first elements!"}},checkCurrentData:function(a){tdcIFrameData._isInitialized&&b.each(tdcIFrameData.tdcTopCollection.models,function(c,b,e){tdcIFrameData._checkModelData(tdcIFrameData.tdcTopCollection.get(c.cid),a)})},changeData:function(a){if(tdcIFrameData._isInitialized){tdcMain.setContentModified();var c=a.$refEl,d=c.prevAll().length;if(a.wasSidebarElementDragged)if(a.wasElementDragged){var g=tdcIFrameData._getDestinationModel(a.$refEl,[".tdc-inner-column",".tdc-column"]);
b.isUndefined(g)&&new tdcNotice.notice("changeData Error: Destination model not in structure data!",!0,!1);var l=tdcIFrameData._getDestinationCol(a.$refEl);g.has("childCollection")||g.set("childCollection",new tdcIFrameData.TdcCollection);var k=g.get("childCollection");var h={},f=c.data("start-values"),p;"undefined"!==typeof f&&(f=JSON.parse(tdcUtil.b64DecodeUnicode(f)),"undefined"!==typeof f&&(b.isArray(f)&&f.length?(h=f[0],1<f.length&&(p=f)):h=f));f=c.data("shortcodeName");h=new tdcIFrameData.TdcModel({content:"",
attrs:h,tag:f,type:"single",level:4,parentModel:g});new tdcIFrameData.TdcLiveView({model:h,el:c[0]});b.isUndefined(p)||h.set("presetValues",p);tdcElementUI.bindElement(c);tdcRecycle.takeSnapshot(h.get("tag")+" : sidebar element added");c.data("model_id",h.cid);k.add(h,{at:d});h.set("parentModel",g);h.getShortcodeRender(l,a.draggedBlockUid,!0)}else if(a.wasTempInnerRowDragged)tdcRecycle.takeSnapshot("Sidebar inner-row added"),g=tdcIFrameData._getDestinationModel(a.$refEl,[".tdc-column"]),b.isUndefined(g)&&
new tdcNotice.notice("changeData Error: Destination model not in structure data!",!0,!1),l=tdcIFrameData._getDestinationCol(a.$refEl),g.has("childCollection")||g.set("childCollection",new tdcIFrameData.TdcCollection),k=g.get("childCollection"),f=c.data("templateContent"),b.isUndefined(f)?(g=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_row_inner",type:"closed",level:3,parentModel:g}),new tdcIFrameData.TdcLiveView({model:g,el:c[0]}),h=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_column_inner",
type:"closed",level:4,parentModel:g}),c.data("model_id",g.cid),k.add(g,{at:d}),c=new tdcIFrameData.TdcCollection,c.add(h),g.set("childCollection",c),c=new tdcIFrameData.TdcCollection,h.set("childCollection",c)):(g=new tdcIFrameData.TdcModel({templateContent:f,attrs:{},tag:"vc_row_inner",type:"template",level:3,parentModel:g}),new tdcIFrameData.TdcLiveView({model:g,el:c[0]}),c.data("model_id",g.cid),k.add(g,{at:d})),g.getShortcodeRender(l,a.draggedBlockUid,!0);else if(a.wasTempRowDragged){tdcRecycle.takeSnapshot("Sidebar row added");
f=c.data("templateContent");g=tdcIFrameData._getDestinationModel(a.$refEl,[".tdc-zone"]);b.isUndefined(g)&&new tdcNotice.notice("changeData Error: Destination model not in structure data!",!0,!1);g.has("childCollection")||g.set("childCollection",new tdcIFrameData.TdcCollection);k=g.get("childCollection");if(b.isUndefined(f)){var q=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_row",type:"closed",level:1,parentModel:g});new tdcIFrameData.TdcLiveView({model:q,el:c[0]});h=new tdcIFrameData.TdcModel({content:"",
attrs:{},tag:"vc_column",type:"closed",level:2,parentModel:q});c.data("model_id",q.cid);d=c.prevAll(".tdc-row").length;k.add(q,{at:d});k=new tdcIFrameData.TdcCollection;k.add(h);q.set("childCollection",k);d=new tdcIFrameData.TdcCollection;h.set("childCollection",d);a.wasElementWithRowDragged&&(k={},g={},f=c.data("start-values"),l=c.data("row-start-values"),"undefined"!==typeof l&&(g=JSON.parse(window.atob(l))),q.set({attrs:g}),"undefined"!==typeof f&&(k=JSON.parse(window.atob(f)),b.isArray(k)&&(k=
k[0])),f=c.data("shortcodeName"),c=new tdcIFrameData.TdcModel({content:"",attrs:k,tag:f,type:"single",level:3,parentModel:h}),d.add(c),h=new tdcIFrameData.TdcCollection,c.set("childCollection",h))}else q=new tdcIFrameData.TdcModel({templateContent:f,attrs:{},tag:"vc_row",type:"template",level:1,parentModel:g}),new tdcIFrameData.TdcLiveView({model:q,el:c[0]}),d=c.prevAll(".tdc-row").length,c.data("model_id",q.cid),b.isUndefined(g)||(k.add(q,{at:d}),g.set("childCollection",k),q.set("childCollection",
new tdcIFrameData.TdcCollection));q.getShortcodeRender(1,a.draggedBlockUid,!0)}else if(a.wasColumnDragged){if(tdcRecycle.takeSnapshot("Column copied"),f=c.data("templateContent"),!b.isUndefined(f)){c=c.data("model_id");if(b.isUndefined(c)){new tdcNotice.notice("changeData Error: Column model id is not in $refEl data!",!0,!1);return}h=tdcIFrameData.getModel(c);if(b.isUndefined(h)){new tdcNotice.notice("changeData Error: Column model not in structure data!",!0,!1);return}h.set("templateContent",f);
h.set("type","template");l=tdcIFrameData._getDestinationCol(a.$refEl);h.getShortcodeRender(l,a.draggedBlockUid,!0)}}else{if(a.wasInnerColumnDragged&&(tdcRecycle.takeSnapshot("Inner column copied"),f=c.data("templateContent"),!b.isUndefined(f))){c=c.data("model_id");if(b.isUndefined(c)){new tdcNotice.notice("changeData Error: Column model id is not in $refEl data!",!0,!1);return}h=tdcIFrameData.getModel(c);if(b.isUndefined(c)){new tdcNotice.notice("changeData Error: Column model not in structure data!",
...
c,e){var d=a.get("childCollection");if("11"===c&&("23_13"===e||"13_23"===e||"13_13_13"===e)){e=e.split("_");var m=e[0].charAt(0)+"/"+e[0].charAt(1),k=d.at(0),f=k.get("attrs");b.isUndefined(f)?k.set("attrs",{width:m}):(f=b.clone(f),f.width=m,k.set("attrs",f));d.add(new tdcIFrameData.TdcModel({content:"",tag:"vc_column",attrs:{width:e[1].charAt(0)+"/"+e[1].charAt(1)},type:"closed",level:1,parentModel:a}));3===e.length&&d.add(new tdcIFrameData.TdcModel({content:"",tag:"vc_column",attrs:{width:e[2].charAt(0)+
"/"+e[2].charAt(1)},type:"closed",level:1,parentModel:a}));tdcIFrameData.changeColumnModel(k,c,e[0])}else if(("23_13"===c||"13_23"===c||"13_13_13"===c)&&"11"===e){c=c.split("_");k=d.at(0);f=k.get("attrs");var n=k.get("childCollection"),p=d.at(1),q=p.get("childCollection");b.isUndefined(f)||(f=b.clone(f),delete f.width,k.set("attrs",f));b.isUndefined(n)&&(n=new tdcIFrameData.TdcCollection,k.set("childCollection",n));!b.isUndefined(q)&&q.length&&b.each(q.models,function(a,c,b){a.set("parentModel",k);
n.add(a)});3===c.length&&(a=d.at(2),d=a.get("childCollection"),!b.isUndefined(d)&&d.length&&b.each(d.models,function(a,c,b){a.set("parentModel",k);n.add(a)}),tdcIFrameData.removeModel(a));tdcIFrameData.removeModel(p);tdcIFrameData.changeColumnModel(k,c[0],e)}else if(!("23_13"!==c&&"13_23"!==c&&"13_13_13"!==c||"23_13"!==e&&"13_23"!==e&&"13_13_13"!==e)){c=c.split("_");e=e.split("_");m=e[0].charAt(0)+"/"+e[0].charAt(1);var t=e[1].charAt(0)+"/"+e[1].charAt(1);k=d.at(0);f=k.get("attrs");p=d.at(1);var v=
p.get("attrs");q=p.get("childCollection");3===e.length?d.add(new tdcIFrameData.TdcModel({content:"",tag:"vc_column",attrs:{width:e[2].charAt(0)+"/"+e[2].charAt(1)},type:"closed",level:1,parentModel:a})):3===c.length&&(a=d.at(2),d=a.get("childCollection"),!b.isUndefined(d)&&d.length&&(b.isUndefined(q)&&(q=new tdcIFrameData.TdcCollection,p.set("childCollection",q)),b.each(d.models,function(a,c,b){a.set("parentModel",p);q.add(a)})),tdcIFrameData.removeModel(a));f=b.clone(f);f.width=m;k.set("attrs",f);
c[0]!==e[0]&&tdcIFrameData.changeColumnModel(k,c[0],e[0]);m=b.clone(v);m.width=t;p.set("attrs",m);c[1]!==e[1]&&tdcIFrameData.changeColumnModel(p,c[1],e[1])}tdcDebug.log(tdcIFrameData.tdcTopCollection.models)},changeFluidStructureModel:function(a,c,e){var d=a.get("childCollection"),m=a.get("tag"),k="vc_column";c=c.split("_");var f=e.split("_");if("vc_row"===m||"vc_row_inner"===m){"vc_row_inner"===m&&(k="vc_column_inner");if(f.length>c.length)for(m=0;m<f.length;m++){e="";for(var n=0;n<f[m].length;n++)e+=
f[m].charAt(n)+"/";""!==e&&(e=e.substring(0,e.length-1));if(m<c.length){var p=d.at(m);n=p.get("attrs");var q=b.clone(n);q.width=e;p.set("attrs",q)}else d.add(new tdcIFrameData.TdcModel({content:"",tag:k,attrs:{width:e},type:"closed",level:1,parentModel:a}))}else for(m=0;m<c.length;m++)if(m<f.length){p=d.at(m);n=p.get("attrs");q=b.clone(n);e="";for(n=0;n<f[m].length;n++)e+=f[m].charAt(n)+"/";""!==e&&(e=e.substring(0,e.length-1));q.width=e;p.set("attrs",q);var t=p}else{p=d.at(f.length);a=p.get("childCollection");
...
function(d,g,m){if("vc_row_inner"===d.get("tag")&&(d=d.get("childCollection"),!b.isUndefined(d)&&d.length)){var f="";b.each(d.models,function(a,c,e){a=a.get("attrs");!b.isUndefined(a)&&b.isObject(a)&&b.has(a,"width")&&(f=c===e.length-1?f+a.width:f+(a.width+"_"))});f=f.replace(/\//g,"");"12_12"!==f&&"23_13"!==f&&"13_23"!==f&&"13_13_13"!==f&&(f="");if("11"===c)if("23"===e)if("23_13"===f){var l=d.at(0),k=d.at(1);m=l.get("attrs");g=k.get("attrs");m=b.clone(m);g=b.clone(g);m.width="1/2";g.width="1/2";
l.set("attrs",m);k.set("attrs",g)}else if("13_23"===f)l=d.at(0),k=d.at(1),m=l.get("attrs"),g=k.get("attrs"),m=b.clone(m),g=b.clone(g),m.width="1/2",g.width="1/2",l.set("attrs",m),k.set("attrs",g);else if("13_13_13"===f){l=d.at(0);k=d.at(1);d=d.at(2);m=l.get("attrs");g=k.get("attrs");var h=d.get("attrs");m=b.clone(m);g=b.clone(g);b.clone(h);m.width="1/2";g.width="1/2";l.set("attrs",m);k.set("attrs",g);g=d.get("childCollection");if(!b.isUndefined(g)&&g.length){var n=k.get("childCollection");b.isUndefined(n)&&
(n=new tdcIFrameData.TdcCollection,k.set("childCollection",n));b.each(g.models,function(a,c,b){n.add(a);a.set("parentModel",k)})}tdcIFrameData.removeModel(d)}else{if(d.models.length){l=d.at(0);m=l.get("attrs");m=b.clone(m);var r=l.get("childCollection");delete m.width;l.set("attrs",m);b.isUndefined(r)&&(r=new tdcIFrameData.TdcCollection,l.set("childCollection",r));var w=0;for(b.each(d.models,function(a,c,e){0!==c&&(w=c,a=a.get("childCollection"),b.isUndefined(a)||b.each(a.models,function(a,c,b){a.set("parentModel",
l);r.add(a)}))});0<w;)tdcIFrameData.removeModel(d.at(w)),w--}}else{if("13"===e&&d.models.length)for(l=d.at(0),m=l.get("attrs"),m=b.clone(m),r=l.get("childCollection"),delete m.width,l.set("attrs",m),b.isUndefined(r)&&(r=new tdcIFrameData.TdcCollection,l.set("childCollection",r)),w=0,b.each(d.models,function(a,c,e){0!==c&&(w=c,a=a.get("childCollection"),b.isUndefined(a)||b.each(a.models,function(a,c,b){a.set("parentModel",l);r.add(a)}))});0<w;)tdcIFrameData.removeModel(d.at(w)),w--}else if("23"===
c)if("11"===e)if("12_12"===f)l=d.at(0),k=d.at(1),m=l.get("attrs"),g=k.get("attrs"),m=b.clone(m),g=b.clone(g),m.width="1/3",g.width="1/3",l.set("attrs",m),k.set("attrs",g),g=new tdcIFrameData.TdcModel({content:"",tag:"vc_column_inner",attrs:{width:"1/3"},type:"closed",level:3,parentModel:a}),d.add(g);else{if(d.models.length)for(l=d.at(0),m=l.get("attrs"),m=b.clone(m),r=l.get("childCollection"),delete m.width,l.set("attrs",m),b.isUndefined(r)&&(r=new tdcIFrameData.TdcCollection,l.set("childCollection",
r)),w=0,b.each(d.models,function(a,c,e){0!==c&&(w=c,a=a.get("childCollection"),b.isUndefined(a)||b.each(a.models,function(a){a.set("parentModel",l);r.add(a)}))});0<w;)tdcIFrameData.removeModel(d.at(w)),w--}else{if("13"===e&&d.models.length)for(l=d.at(0),m=l.get("attrs"),m=b.clone(m),r=l.get("childCollection"),delete m.width,l.set("attrs",m),b.isUndefined(r)&&(r=new tdcIFrameData.TdcCollection,l.set("childCollection",r)),w=0,b.each(d.models,function(a,c,e){0!==c&&(w=c,a=a.get("childCollection"),b.isUndefined(a)||
b.each(a.models,function(a,c,b){a.set("parentModel",l);r.add(a)}))});0<w;)tdcIFrameData.removeModel(d.at(w)),w--}else if("13"===c)if("11"===e)if(""===f||"12_12"!==f&&"23_13"!==f&&"13_23"!==f&&"13_13_13"!==f){if(d.models.length)for(l=d.at(0),m=l.get("attrs"),m=b.clone(m),r=l.get("childCollection"),delete m.width,l.set("attrs",m),b.isUndefined(r)&&(r=new tdcIFrameData.TdcCollection,l.set("childCollection",r)),w=0,b.each(d.models,function(a,c,e){0!==c&&(w=c,a=a.get("childCollection"),b.isUndefined(a)||
b.each(a.models,function(a,c,b){a.set("parentModel",l);r.add(a)}))});0<w;)tdcIFrameData.removeModel(d.at(w)),w--}else"12_12"===f&&d.models.length&&(l=d.at(0),k=d.at(1),m=l.get("attrs"),g=k.get("attrs"),m.width="1/3",g.width="1/3",l.set("attrs",m),k.set("attrs",g),d.add(new tdcIFrameData.TdcModel({content:"",tag:"vc_column_inner",attrs:{width:"1/3"},type:"closed",level:1,parentModel:a})));else if("23"===e&&(""===f||"12_12"!==f)&&d.models.length)for(l=d.at(0),m=l.get("attrs"),m=b.clone(m),r=l.get("childCollection"),
delete m.width,l.set("attrs",m),b.isUndefined(r)&&(r=new tdcIFrameData.TdcCollection,l.set("childCollection",r)),w=0,b.each(d.models,function(a,c,e){0!==c&&(w=c,a=a.get("childCollection"),b.isUndefined(a)||b.each(a.models,function(a,c,b){a.set("parentModel",l);r.add(a)}))});0<w;)tdcIFrameData.removeModel(d.at(w)),w--}})}}},changeInnerRowModel:function(a,c,e){if(!(b.isUndefined(a)||b.isUndefined(c)||b.isUndefined(e))){var d=a.get("childCollection");if("11"!==c||"12_12"!==e&&"23_13"!==e&&"13_23"!==
e&&"13_13_13"!==e)if("12_12"!==c&&"23_13"!==c&&"13_23"!==c||"11"!==e&&"12_12"!==e&&"23_13"!==e&&"13_23"!==e&&"13_13_13"!==e)"13_13_13"!==c||"11"!==e&&"12_12"!==e&&"23_13"!==e&&"13_23"!==e?tdcIFrameData.changeFluidStructureModel(a,c,e):("11"===e?(q=d.at(0),t=q.get("attrs"),m=q.get("childCollection"),h=d.at(1),f=h.get("childCollection"),a=d.at(2),d=a.get("childCollection"),b.isUndefined(t)||(t=b.clone(t),delete t.width,q.set("attrs",t)),b.isUndefined(m)&&(m=new tdcIFrameData.TdcCollection,q.set("childCollection",
m)),!b.isUndefined(f)&&f.length&&b.each(f.models,function(a,c,b){a.set("parentModel",q);m.add(a)}),!b.isUndefined(d)&&d.length&&b.each(d.models,function(a,c,b){a.set("parentModel",q);m.add(a)}),tdcIFrameData.removeModel(h)):(n=e.split("_"),p=n[0].charAt(0)+"/"+n[0].charAt(1),c=n[1].charAt(0)+"/"+n[1].charAt(1),q=d.at(0),t=q.get("attrs"),h=d.at(1),e=h.get("attrs"),f=h.get("childCollection"),a=d.at(2),d=a.get("childCollection"),t=b.clone(t),t.width=p,q.set("attrs",t),e=b.clone(e),e.width=c,h.set("attrs",
e),b.isUndefined(f)&&(f=new tdcIFrameData.TdcCollection,h.set("childCollection",f)),!b.isUndefined(d)&&d.length&&b.each(d.models,function(a,c,b){a.set("parentModel",h);f.add(a)})),tdcIFrameData.removeModel(a));else if("11"===e){q=d.at(0);t=q.get("attrs");var m=q.get("childCollection");h=d.at(1);var f=h.get("childCollection");b.isUndefined(t)||(t=b.clone(t),delete t.width,q.set("attrs",t));b.isUndefined(m)&&(m=new tdcIFrameData.TdcCollection,q.set("childCollection",m));!b.isUndefined(f)&&f.length&&
b.each(f.models,function(a,c,b){a.set("parentModel",q);m.add(a)});tdcIFrameData.removeModel(h)}else n=e.split("_"),p=n[0].charAt(0)+"/"+n[0].charAt(1),c=n[1].charAt(0)+"/"+n[1].charAt(1),q=d.at(0),t=q.get("attrs"),h=d.at(1),e=h.get("attrs"),t=b.clone(t),t.width=p,q.set("attrs",t),e=b.clone(e),e.width=c,h.set("attrs",e),3===n.length&&d.add(new tdcIFrameData.TdcModel({content:"",tag:"vc_column_inner",attrs:{width:n[2].charAt(0)+"/"+n[2].charAt(1)},type:"closed",level:3,parentModel:a}));else{var h=new tdcIFrameData.TdcModel({content:"",
tag:"vc_column_inner",type:"closed",level:3,parentModel:a}),n=e.split("_"),p=n[0].charAt(0)+"/"+n[0].charAt(1);c=n[1].charAt(0)+"/"+n[1].charAt(1);var q=d.at(0),t=q.get("attrs");b.isUndefined(t)?q.set("attrs",{width:p}):(t=b.clone(t),t.width=p,q.set("attrs",t));h.set("attrs",{width:c});d.add(h);3===n.length&&d.add(new tdcIFrameData.TdcModel({content:"",tag:"vc_column_inner",attrs:{width:n[2].charAt(0)+"/"+n[2].charAt(1)},type:"closed",level:3,parentModel:a}))}}},getChildCollectionWidths:function(a){if(!b.isUndefined(a)){var c;
...
var k=a.data("max_"+f);f=a.data("step_"+f);a.get(0).min=e;a.get(0).max=k;a.get(0).step=f;""===g?(c.val(d),a.val(d)):(c.val(g),a.val(g));a=a.get(0)}d="";c=jQuery(a).parent().find('input[type="radio"]:checked');c.length&&(d=jQuery(c[0]).data("unit_value"));"focusin"===b.type?a.oldValue=a.value+d:(b=a.value+d,d=tdcIFrameData.getModel(jQuery(a).data("model_id")),tdcSidebarController.onUpdate(d,jQuery(a).data("param_name"),a.oldValue,_.escape(b)),a.oldValue=b)});d.on("keyup change input",".tdc-tab-no-design .tdc-property-range_multiple-responsive input",
function(b){var e=jQuery(this),a=e.closest(".tdc-property-responsive"),c=a.find('input[type="range"]'),d=a.find('input[type="radio"]:checked'),g=a.find('input[type="text"]'),f=c.get(0),k="",h=d.data("default_value"),n=tdcIFrameData.getModel(c.data("model_id")),p=c.data("param_name"),q=window.tdcAdminSettings.mappedShortcodes[n.attributes.tag],t=n="";var v=[];for(var u=0;u<q.params.length;u++)if(p===q.params[u].param_name){u=q.params[u].tdc_values;for(var r in u)u.hasOwnProperty(r)&&(v.push(u[r].unit),
...
v||_.isUndefined(h)||""===h?(c.val(v),d.data("last_value",v),c.data("data-to-save",tdcSidebarPanel.updateTextfieldResponsiveValues(c.attr("name"),v+k,tdcSidebar.currentViewportSettings.name))):(c.data("data-to-save",tdcSidebarPanel.deleteResponsiveValue("tdc-param-"+p,tdcSidebar.currentViewportSettings.name)),c.data("range_value",n),c.data("range_unit",t),c.val(n),k=a.find('input[type="radio"][data-unit_value="'+t+'"]'),q=k.data("unit"),r=c.data("min_"+q),d=c.data("max_"+q),q=c.data("step_"+q),k.prop("checked",
!0),f.min=r,f.max=d,f.step=q,f.value=n,k.data("last_value",n),g.val(n));else if(""===v)if(k=tdcSidebarPanel.getCurrentResponsiveValue(c.attr("name"),"all"),"undefined"===typeof k)c.data("data-to-save",tdcSidebarPanel.deleteResponsiveValue("tdc-param-"+p,tdcSidebar.currentViewportSettings.name)),c.data("range_value",n),c.data("range_unit",t),c.val(n),k=a.find('input[type="radio"][data-unit_value="'+t+'"]'),q=k.data("unit"),r=c.data("min_"+q),d=c.data("max_"+q),q=c.data("step_"+q),k.prop("checked",
!0),f.min=r,f.max=d,f.step=q,f.value=n,k.data("last_value",n),g.val(n),a.addClass("tdc-css-inherited");else for(u=0;u<q.params.length;u++){if(p===q.params[u].param_name){v=[];g=[];u=q.params[u].tdc_values;for(r in u)u.hasOwnProperty(r)&&v.push(u[r].unit);for(u=0;u<v.length&&!(g=k.split(v[u]),1<g.length);u++);g.length&&(n=g[0],t=v[u],c.data("range_value",n),c.data("range_unit",t),k=a.find('input[type="radio"][data-unit_value="'+t+'"]'),q=k.data("unit"),r=c.data("min_"+q),d=c.data("max_"+q),q=c.data("step_"+
q),k.prop("checked",!0),f.min=r,f.max=d,f.step=q,f.value=n,k.data("last_value",n),a.find('input[type="text"]').val(n));c.data("data-to-save",tdcSidebarPanel.deleteResponsiveValue("tdc-param-"+p,tdcSidebar.currentViewportSettings.name));a.addClass("tdc-css-inherited");break}}else c.val(v),d.data("last_value",v),c.data("data-to-save",tdcSidebarPanel.updateTextfieldResponsiveValues(c.attr("name"),v+k,tdcSidebar.currentViewportSettings.name))}else if("radio"===e.attr("type")){if("input"===b.type)return;
p=d.data("last_value");q=d.data("unit");r=c.data("min_"+q);d=c.data("max_"+q);q=c.data("step_"+q);f.min=r;f.max=d;f.step=q;""===p?(g.val(h),c.val(h),v=h):(g.val(p),c.val(p),v=p);c.data("data-to-save",tdcSidebarPanel.updateTextfieldResponsiveValues(c.attr("name"),v+k,tdcSidebar.currentViewportSettings.name));a.removeClass("tdc-css-inherited")}k="";a=jQuery(f).parent().find('input[type="radio"]:checked');a.length&&(k=jQuery(a[0]).data("unit_value"));"focusin"===b.type?f.oldValue=f.value+k:(a=jQuery(f),
b=a.data("data-to-save"),n=tdcIFrameData.getModel(a.data("model_id")),f.oldValue!==b&&(tdcSidebarController.onUpdate(n,jQuery(f).data("param_name"),f.oldValue,_.escape(b)),f.oldValue=b))});d.on("focus change",".tdc-tab-no-design .tdc-property-checkbox input",function(b){if("focusin"===b.type)this.oldValue=this.value;else{b=jQuery(this);var e=b.val();b.is(":checked")||(e="");var a=tdcIFrameData.getModel(b.data("model_id"));tdcSidebarController.onUpdate(a,b.data("param_name"),this.oldValue,e);this.oldValue=
e}});d.on("focus change",".tdc-tab-no-design .tdc-property-checkbox-responsive input",function(b){if("focusin"===b.type)this.oldValue=this.value;else{b=jQuery(this);var e=b.val(),a=tdcIFrameData.getModel(b.data("model_id")),c=b.data("param_name");b.is(":checked")||(e="");var d=b.attr("name"),g=b.closest(".tdc-property-responsive");e="all"===tdcSidebar.currentViewportSettings.name&&""===e?tdcSidebarPanel.deleteResponsiveValue(d,tdcSidebar.currentViewportSettings.name):tdcSidebarPanel.updateCheckboxResponsiveValues(d,
e,tdcSidebar.currentViewportSettings.name);g.removeClass("tdc-css-inherited");g.find(".tdc-inherit-checkbox").hide();"all"!==tdcSidebar.currentViewportSettings.name&&(d=tdcSidebarPanel.getCurrentResponsiveValue(b.attr("name"),tdcSidebar.currentViewportSettings.name),g=b.closest(".tdc-property-responsive"),"undefined"===typeof d?(d=tdcSidebarPanel.getCurrentResponsiveValue(b.attr("name"),"all"),"undefined"!==typeof d&&(g.addClass("tdc-css-inherited"),g.find(".tdc-inherit-checkbox").show())):(g.removeClass("tdc-css-inherited"),
g.find(".tdc-inherit-checkbox").show()),g.find(".tdc-inherit-checkbox").show());tdcSidebarController.onUpdate(a,c,this.oldValue,e);this.oldValue=e}});d.on("click",".tdc-tab-no-design .tdc-image-wrap",tdcSidebarPanel.tdcImageWrapHandler);d.on("click",".tdc-tab-no-design .tdc-image-remove",tdcSidebarPanel.tdcImageRemoveHandler);d.on("click",".tdc-tab-no-design .tdc-icon-wrap",tdcSidebarPanel.tdcIconWrapHandler);d.on("click",".tdc-tab-no-design .tdc-icon-remove",tdcSidebarPanel.tdcIconRemoveHandler);
d.on("click",".tdc-tab-no-design .tdc-inherit-select",tdcSidebarPanel.tdcInheritSelectHandler);d.on("click",".tdc-tab-no-design .tdc-inherit-checkbox",tdcSidebarPanel.tdcInheritCheckboxHandler);d.on("click",".tdc-icon-selector-content > span",function(b){b=jQuery("#tdc-icon-selector");b.length||(b=tdcSidebar.buildIconSelector());b.find(".selected").removeClass("selected");var e=jQuery(this),a=e.data("font_class"),c=tdcIFrameData.getModel(b.data("model_id"));e.addClass("selected");var d=b.prev(".tdc-property-wrap");
d.find(".tdc-icon-wrap").html(e.html());d.find(".tdc-icon-remove").removeClass("tdc-hidden-button");tdcSidebarController.onUpdate(c,b.data("param_name"),"",a)});d.on("change","#tdc-icon-selector .tdc-icon-selector-lib",function(){var b=jQuery("#tdc-icon-selector");b.length||(b=tdcSidebar.buildIconSelector());var e=jQuery(this).val(),a=b.find(".tdc-icon-selector-filter");b.find(".tdc-icon-selector-content").children(".tdc-font-separator").each(function(){var c=jQuery(this),b=c.data("font_id");""===
e||e===b?(c.show(),c.nextAll("span").each(function(){var c=jQuery(this),b=c.data("font_class"),e=a.val().trim();""!==e&&-1===b.indexOf(e)?c.hide():c.show()})):(c.hide(),c.nextAll("span").hide())})});d.on("click",".tdc-tab-no-design .tdc-gradient-wrap",function(b){b=jQuery("#tdc-gradient");b.length||(b=tdcSidebar.buildGradient());var e=jQuery(this),a=e.closest(".tdc-property-wrap");e=e.next("input").val();b.toggle();a.after(b);a.next().find(".wp-picker-container").find("input.wp-color-picker").tdGradientColorPicker("open_gradient",
e)});d.on("click",".tdc-colorpicker-wrap",function(b){tdcSidebarPanel.showHideTdcPalette.call(this,b)});d.on("mousedown",function(b){var e=jQuery("#tdc-sidebar"),a=jQuery("#tdc-icon-selector"),c=jQuery("#tdc-gradient"),d=jQuery("#tdc-palette"),g=jQuery("#tdc-font-list"),f=jQuery(".tdc-preset-values-list");a.length?a.get(0).contains(b.target)||(a.hide(),e.after(a)):a=tdcSidebar.buildIconSelector();c.length?c.get(0).contains(b.target)||(a=jQuery(b.target),a.hasClass("tdc-gradient-wrap")||(c.hide(),
e.after(c))):c=tdcSidebar.buildGradient();d.length?d.get(0).contains(b.target)||(a=jQuery(b.target),a.hasClass("tdc-colorpicker-wrap")||(d.hide(),e.after(d),d.find("input.wp-color-picker").tdPaletteColorPicker("save_color"))):d=tdcSidebar.buildPalette();g.length&&!g.get(0).contains(b.target)&&(g.hide(),e.after(g));!f.length||f.get(0).contains(b.target)||jQuery(".tdc-preset-values").get(0).contains(b.target)?f.is(":visible")&&jQuery(".tdc-preset-values").get(0).contains(b.target)&&setTimeout(function(){tdcSidebar.setSettings({$currentZone:tdcSidebar.getCurrentZone(),
...
var e=jQuery(this);tdcSidebarPanel.timerChangingColumns=setTimeout(function(){var a=e.val(),c=tdcSidebar.getCurrentRow().data("model_id");c=tdcIFrameData.getModel(c);var b=c.get("childCollection");this.oldValue="11";_.isUndefined(b)||(b=tdcIFrameData.getChildCollectionWidths(b),_.isUndefined(b)||(this.oldValue=b));"11"===this.oldValue&&("23_13"===a||"13_23"===a||"13_13_13"===a)||"23_13"===this.oldValue&&("11"===a||"13_23"===a||"13_13_13"===a)||"13_23"===this.oldValue&&("11"===a||"23_13"===a||"13_13_13"===
a)||"13_13_13"===this.oldValue&&("11"===a||"23_13"===a||"13_23"===a)?(tdcIFrameData.changeRowModel(c,this.oldValue,a),c.getShortcodeRender(1,null,!0)):this.oldValue!==a&&(tdcIFrameData.changeFluidStructureModel(c,this.oldValue,a),c.getShortcodeRender(1,null,!0));this.oldValue=a},300)});d.on("change",".tdc-tab-no-design .tdc-property-dropdown.tdc-add-class input.tdc-property-input-radio",function(b){if("focusin"===b.type||"focus"===b.type)this.oldValue=this.value;else{b=jQuery(this);var e=b.val(),
a=tdcIFrameData.getModel(b.data("model_id"));tdcSidebarController.onUpdate(a,b.data("param_name"),this.oldValue,e);this.oldValue=e}});d.on("change focus",".tdc-tab-no-design .tdc-innerRow-col-dropdown select",function(b){if("focusin"===b.type||"focus"===b.type)this.oldValue=this.value;else{b=jQuery(this).val();var e=tdcSidebar._$currentInnerRow.data("model_id");e=tdcIFrameData.getModel(e);tdcIFrameData.changeInnerRowModel(e,this.oldValue,b);e.getShortcodeRender(tdcIFrameData.getColumnNumber(e),null,
!0);this.oldValue=b}});d.on("change",".tdc-tab-no-design .tdc-innerRow-col-dropdown input.tdc-property-input-radio",function(b){"undefined"!==typeof tdcSidebarPanel.timerChangingInnerColumns&&clearTimeout(tdcSidebarPanel.timerChangingInnerColumns);var e=jQuery(this);tdcSidebarPanel.timerChangingInnerColumns=setTimeout(function(){var a=e.val(),c=tdcSidebar._$currentInnerRow.data("model_id");c=tdcIFrameData.getModel(c);var b=c.get("childCollection");this.oldValue="11";_.isUndefined(b)||(b=tdcIFrameData.getChildCollectionWidths(b),
...
b}});d.on("click",".tdc-tab-no-design .tdc-open-wpeditor",function(b){b.preventDefault();var e=jQuery(this);b=jQuery("#tdc-wpeditor");var a=b.children(".content"),c=e.data("mapped_parameter_name");e=e.data("model_id");var d=tdcIFrameData.getModel(e).get("parentModel").get("attrs"),g="tdc-three-column";if(_.has(d,"width"))switch(d.width){case "1/3":g="tdc-one-column";break;case "2/3":g="tdc-two-column"}a.addClass("tdc-dropped-wpeditor");a.html('<iframe id="tdc-iframe-wpeditor" class="'+g+'" src="'+
...
".tdc-sidebar-shortcode-row",function(b){b=jQuery(b.currentTarget).data("model_id");b=tdcIFrameData.getModel(b);var e={error:f,getShortcode:""};_.isUndefined(b)||tdcIFrameData._checkModelData(b,e);_.isUndefined(e.getShortcode)||console.log(e.getShortcode)});d.on("click",".tdc-sidebar-current-styles-settings",function(b){b=tdcSidebarPanel.getCurrentStyleSettings(b);if(!_.isUndefined(b)){var e="",a;for(a in b)e+='"'+a+'" => "'+b[a]+'",\n';console.log(e)}});d.on("click",".tdc-sidebar-font-reset",function(b){tdConfirm.modal({caption:"Clear Font Settings",
htmlInfoContent:"This will clear all values for this font group settings.",textYes:"Yes",objectContext:this,callbackYes:function(){tb_remove();var b=jQuery(this),a=b.data("model_id"),c=tdcIFrameData.getModel(a),d=c.get("attrs");d=_.clone(d);for(var g="font-family font-size font-line-height font-style font-weight font-transform font-spacing".split(" "),f="",k=0;k<g.length;k++){var h=b.closest(".tdc-font-manager-wrap").nextAll(".tdc-"+g[k]+":first");if(h.length){var n=h.find('[data-model_id="'+a+'"]');
n.length&&(n.val(""),n.data("responsive",""),h.removeClass("tdc-css-inherited"),f=h.find(".tdc-inherit"),f.length&&f.hide(),f=n.data("placeholder"),"undefined"!==typeof f&&n.attr("placeholder",f),f=n.data("param_name"),delete d[f],n=n.attr("name"),tdcSidebarPanel.deleteResponsiveValues(n))}}c.set("attrs",d);tdcSidebarController.onUpdate(c,f,"","")}})});d.on("click",".tdc-sidebar-font-save",function(b){b=jQuery(this);var e=b.data("model_id");e=tdcIFrameData.getModel(e).get("attrs");var a=b.data("param_name").replace("font_settings",
""),c="font_family font_size font_line_height font_style font_weight font_transform font_spacing".split(" "),d={};_.each(e,function(b,e,f){if(0===e.indexOf(a))for(f=0;f<c.length;f++)if(0<e.indexOf(c[f])){d[c[f]]=b;break}});_.isEmpty(d)||tdConfirm.modal({caption:"Saving Font Settings",htmlInfoContent:function(){setTimeout(function(){jQuery("#TB_ajaxContent").find("input").focus()},100);return'<label>Font Name: </label><input type="text" autofocus><div class="info"></div>'},textYes:"Save",textNo:"Cancel",
...
value:window.btoa(JSON.stringify(d))}),tdcUtil.updateTdcSavings(window,function(){jQuery("#TB_ajaxContent").find(".info").html("Font has been saved!");setTimeout(function(){tb_remove()},500)})):c.html("Font name already exists! Choose another one")}}})});d.on("click",".tdc-sidebar-font-load",function(){var b=jQuery(this),e=b.closest(".tdc-property-wrap"),a=b.data("model_id"),c=b.data("param_name");if(""!==window.tdcAdminSettings.tdcSavings&&("undefined"!==typeof window.tdcAdminSettings.tdcSavings.fonts||
...
b.name+'</span><span class="tdc-font-delete"></span></div>').appendTo(d)}));if("undefined"!==typeof window.tdcAdminSettings.tdcSavings.recentFonts){jQuery('<div class="tdc-font-list-header"><span>Recent fonts</span></div>').appendTo(d);b=_.invert(window.tdcAdminSettings.mappedFontFamily);for(var g=window.tdcAdminSettings.tdcSavings.recentFonts.length;0<g;g--){var f=window.tdcAdminSettings.tdcSavings.recentFonts[g],k=b[f];_.isUndefined(k)||jQuery('<div class="tdc-recent-font-settings" data-value="'+
f+'" data-model_id="'+a+'" data-param_name="'+c+'"><span class="tdc-font-name">'+k+'</span><span class="tdc-recent-font-delete"></span></div>').appendTo(d)}}e.after(d);d.toggle()}});d.on("click",".tdc-font-delete",function(b){b.stopImmediatePropagation();var e=jQuery(this).closest(".tdc-font-settings");b=e.data("name");b=_.findIndex(window.tdcAdminSettings.tdcSavings.fonts,{name:b});window.tdcAdminSettings.tdcSavings.fonts.splice(b,1);tdcUtil.updateTdcSavings(this,function(){e.remove()})});d.on("click",
".tdc-recent-font-delete",function(b){b.stopImmediatePropagation();var e=jQuery(this).closest(".tdc-recent-font-settings");b=e.data("name");b=_.findIndex(window.tdcAdminSettings.tdcSavings.recentFonts,{name:b});window.tdcAdminSettings.tdcSavings.recentFonts.splice(b,1);tdcUtil.updateTdcSavings(this,function(){e.remove()})});d.on("click",".tdc-font-settings",function(){var b=jQuery(this),e=b.data("value");e=JSON.parse(window.atob(e));var a=b.data("model_id");a=tdcIFrameData.getModel(a);var c=a.get("attrs"),
d=b.data("param_name").replace("font_settings",""),g="font_family font_size font_line_height font_style font_weight font_transform font_spacing".split(" ");_.each(e,function(a,b,e){-1!==_.indexOf(g,b)&&(c[d+b]=a)});a.set({attrs:c,rebindToPanel:!0});tdcSidebarController.onUpdate(a)});d.on("click",".tdc-recent-font-settings",function(){var b=jQuery(this),e=b.data("value"),a=b.data("model_id");a=tdcIFrameData.getModel(a);var c=a.get("attrs");b=b.data("param_name").replace("font_settings","");c[b+"font_family"]=
e;a.set({attrs:c,rebindToPanel:!0});tdcSidebarController.onUpdate(a)});tdcSidebarPanel.$_paramNameSwitch=d.find(".tdc-param-name-switch");if(0<tdcSidebarPanel.$_paramNameSwitch.length)d.on("click",".tdc-param-name-switch",function(){jQuery(this).toggleClass("tdc-param-name-switch-active");jQuery(".tdc-param-name").toggleClass("tdc-param-name-active")})},getCurrentStyleSettings:function(d,b){if(_.isUndefined(b)){var e=jQuery(d.currentTarget).data("model_id");b=tdcIFrameData.getModel(e);e={error:f};
_.isUndefined(b)||tdcIFrameData._checkModelData(b,e)}var a=b.get("tag");e=b.get("attrs");e=_.clone(e);if(!_.isUndefined(e)){var c={},m={};for(g in e)0===g.indexOf("tds_")&&(c[g]=e[g]);var g=window.tdcAdminSettings.mappedShortcodes[a].params;for(a=0;a<g.length;a++){var l=!1,k=g[a];if(0===k.param_name.indexOf("tds_")){for(var h in c)if(k.param_name===h){m[h]=c[h];l=!0;break}l||(m[k.param_name]="")}}for(h in c)switch(g=h.split("-"),g.length){case 2:if(!_.has(m,h)){c=g[0];g=!1;for(var n in m)if(c===m[n]&&
1===n.split("-").length){g=!0;break}if(!g){var p;for(p in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[p],c)){var q=p;break}_.has(m,q)&&""===m[q]&&window.tdcAdminSettings.globalStyle[q]===c&&(g=!0)}g||delete e[h]}break;case 3:c=g[0];a=g[2];for(p in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[p],c)){q=p;break}g=!1;for(n in m)if(c===m[n]&&n===q+"-"+a){g=!0;break}g||_.has(m,q+"-"+a)&&""===m[q+"-"+a]&&window.tdcAdminSettings.globalStyle[q]===
c&&(g=!0);g||delete e[h]}return e}},getCurrentListAtts:function(d,b,e){_.isUndefined(b)&&(d=jQuery(d.currentTarget).data("model_id"),b=tdcIFrameData.getModel(d),d={error:f},_.isUndefined(b)||tdcIFrameData._checkModelData(b,d));d=b.get("tag");b=b.get("attrs");var a=_.clone(b);if(!_.isUndefined(a)){var c={};b={};for(var m in a)0===m.indexOf("tds_")&&(c[m]=a[m]);m=window.tdcAdminSettings.mappedShortcodes[d].params;for(var g=0;g<m.length;g++){var l=!1,k=m[g];if(0===k.param_name.indexOf("tds_")){for(var h in c)if(k.param_name===
h){b[h]=c[h];l=!0;break}l||(b[k.param_name]="")}}for(h in c)switch(c=h.split("-"),c.length){case 2:if(!_.has(b,h)){m=c[0];c=!1;for(var n in b)if(m===b[n]&&1===n.split("-").length){c=!0;break}if(!c){var p;for(p in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[p],m)){var q=p;break}_.has(b,q)&&""===b[q]&&window.tdcAdminSettings.globalStyle[q]===m&&(c=!0)}c||delete a[h]}break;case 3:m=c[0];l=c[2];for(p in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[p],
m)){q=p;break}c=!1;for(n in b)if(m===b[n]&&n===q+"-"+l){c=!0;break}c||_.has(b,q+"-"+l)&&""===b[q+"-"+l]&&window.tdcAdminSettings.globalStyle[q]===m&&(c=!0);c||delete a[h]}var t=[],v;for(v in window.tdcAdminSettings.listStyles[e])if(v===d){for(g=0;g<window.tdcAdminSettings.listStyles[e][v].length;g++)h=window.tdcAdminSettings.listStyles[e][v][g],_.isArray(h)?_.map(h,function(c){_.isUndefined(a[c])||(_.isUndefined(t[g])&&(t[g]=[]),t[g].push(a[c]))}):_.isUndefined(a[h])||(_.isArray(a[h])&&a[h].length?
t[g]=a[h][0]:t[g]=a[h]);break}return t}},showHideTdcPalette:function(d){d=jQuery("#tdc-palette");var b=jQuery(this).closest(".tdc-property-wrap");d.length||tdcSidebar.buildPalette();b.next("#tdc-palette").length?(d.toggle(),tdcSidebarPanel.saveTdcPalette()):(tdcSidebarPanel.saveTdcPalette(),b.after(d),d.show(),tdcSidebarPanel.openTdcPalette())},saveTdcPalette:function(){var d=jQuery("#tdc-palette"),b=d.prev(".tdc-property-wrap");d.length||tdcSidebar.buildPalette();b.length&&(b=b.find("input").val(),
d=d.find("input.wp-color-picker"),d.tdPaletteColorPicker("open_palette",b),d.tdPaletteColorPicker("save_color"))},openTdcPalette:function(){var d=jQuery("#tdc-palette"),b=d.prev(".tdc-property-wrap");d.length||tdcSidebar.buildPalette();b.length&&(b=b.find("input").val(),d.find("input.wp-color-picker").tdPaletteColorPicker("open_palette",b))},tdcIconWrapHandler:function(d){var b=jQuery(this),e=jQuery("#tdc-icon-selector");e.length||(e=tdcSidebar.buildIconSelector());var a=b.closest(".tdc-property-wrap");
d=e.find(".tdc-icon-selector-filter");var c=e.find(".tdc-icon-selector-lib"),f=e.find(".tdc-icon-selector-content");c.val("");d.val("");f.children().each(function(){jQuery(this).show()});e.data("model_id",b.data("model_id"));e.data("param_name",b.data("param_name"));e.show();a.after(e);b=e.data("param_name");e=tdcIFrameData.getModel(e.data("model_id")).get("attrs");var g="";_.has(e,b)&&(g=e[b].trim());d.focus();f.find("span").each(function(){var a=jQuery(this),b=a.data("font_class");if(g===b){for(a.addClass("selected");!a.prev(".tdc-font-separator").length;)a=
...
window.original_send_to_editor=window.send_to_editor;wp.media.editor.open(b);jQuery(".media-menu .media-menu-item:nth-of-type(2)").addClass("hidden");jQuery(".media-menu .media-menu-item:nth-of-type(3)").addClass("hidden");jQuery(".media-menu .media-menu-item:nth-of-type(4)").addClass("hidden");window.send_to_editor=function(e){var a=jQuery("img",e).attr("src"),c="",d="",g="";"undefined"===typeof a?(a=jQuery(e).attr("src"),c=jQuery(e).attr("class"),d=jQuery(e).attr("height"),g=jQuery(e).attr("width")):
(c=jQuery("img",e).attr("class"),d=jQuery("img",e).attr("height"),g=jQuery("img",e).attr("width"));jQuery.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/get_image_id","uuid="+tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},dataType:"json",data:{image_class:c,action:"tdc_ajax_get_image_id"}}).done(function(c,e,f){"success"===e&&(_.isObject(c)&&_.has(c,"errors")?new tdcNotice.notice(c.errors,!0,!1):(b.closest(".tdc-property").find(".tdc-image-remove").removeClass("tdc-hidden-button"),
b.attr("style","background-image: url( '"+a+"') "),b.data("image_link",a),b.data("image_id",c.image_id),b.data("image_height",d),b.data("image_width",g),b.removeClass("tdc-no-image-selected"),window.send_to_editor=window.original_send_to_editor,window.tb_remove(),e="",f=b.data("model_id"),f=tdcIFrameData.getModel(f),b.hasClass("tdc-no-image-selected")||(e=c.image_id.toString()),c=f.get("attrs"),c.media_size_image_height=d,c.media_size_image_width=g,f.set("attrs",c),tdcSidebarController.onUpdate(f,
...
"";if("undefined"===typeof b)return e;e+=' data-model_id="'+b.cid+'"';"undefined"!==typeof d&&(e+=' data-param_name="'+d.param_name+'"',"woo_shortcode"===d.param_name&&(e+='id="woo_shortcode" '));return e},_fixGroupName:function(d){switch(d){case "Design options":return"Css";case "Pagination":return"Extra";case "Ajax filter":return"Ajax"}return d},clearPanel:function(){tdcSidebarPanel._deletePanel()},blurInputPanel:function(){jQuery("body").find("input").blur()},_addPresetValuesSelector:function(d,
b){var e='<div class="tdc-preset-values tdc-sidebar-horizontal-separator"><i class="tdc-font-fa tdc-font-fa-cube"></i>Pre-made style presets<i class="tdc-font-fa tdc-font-fa-angle-right"></i></div><ul class="tdc-preset-values-list" data-model_id="'+(b.cid+'">');for(var a=1;a<d.length;a++){var c="";_.isUndefined(d[a].tdc_preset_individual)||(c='data-individual="1"');var f="";_.isUndefined(d[a].tdc_preset_class)||(f=' class="'+d[a].tdc_preset_class+'"');e+="<li "+c+" "+f+' data-values="'+window.btoa(JSON.stringify(d[a]))+
'">'+d[a].tdc_preset_name+"</li>"}e+="</ul>";tdcSidebarPanel._hook.hasCallback("panel_rendered",tdcSidebarPanel.callbackPresets)||tdcSidebarPanel._hook.addAction("panel_rendered",tdcSidebarPanel.callbackPresets);return e},callbackPresets:function(){jQuery(".tdc-preset-values").click(function(){jQuery(this).next(".tdc-preset-values-list").toggle()});jQuery(".tdc-preset-values-list > li").click(function(){var d=jQuery(this),b=d.data("individual"),e=d.parent(".tdc-preset-values-list");d=JSON.parse(window.atob(d.data("values")));
...
e.indexOf("tds_")||(c[e]=b)}),a.set("attrs",c));tdcSidebarController.onUpdate(a)})},addColorpicker:function(d,b){var e="";_.has(d,"description")&&""!==d.description&&(e=' title="'+d.description+'" ');var a='<div class="'+tdcSidebarPanel._getParameterClasses(d)+'">';a+='<div class="tdc-property-title"><span class="tdc-search-data"'+e+">"+d.heading+"</span></div>";a=a+'<div class="tdc-property"><div class="tdc-colorpicker-wrap" title="'+(d.heading+'">');a=a+"</div><input "+(tdcSidebarPanel._getParamterDataAtts(d,
b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+'" type="hidden" value="'+tdcSidebarPanel._getParameterCurrentValue(d,b)+'"/>');a=a+'</div><span class="tdc-param-name">'+(d.param_name+"</span>");a+="</div>";tdcSidebarPanel._hook.hasCallback("panel_rendered",tdcSidebarPanel.callbackColorPicker)||tdcSidebarPanel._hook.addAction("panel_rendered",tdcSidebarPanel.callbackColorPicker);return a},addCustom:function(d,b){var e="";_.has(d,"description")&&""!==d.description&&(e=' title="'+d.description+
'" ');var a='<div class="'+tdcSidebarPanel._getParameterClasses(d)+'">';a+='<div class="tdc-property-title"><span class="tdc-search-data"'+e+">"+d.heading+"</span></div>";a=a+'<div class="tdc-property">'+d.value;a=a+'</div><span class="tdc-param-name">'+(d.param_name+"</span>");return a+"</div>"},callbackColorPicker:function(){jQuery("#tdc-palette-color-picker").tdPalette();jQuery(".tdc-tab-no-design .tdc-property-colorpicker").each(function(){var d=jQuery(this),b=d.find("input");d=d.find(".tdc-colorpicker-wrap");
_.isUndefined(b.val())||""===b.val()||d.attr("style","background: "+b.val())})},addGradient:function(d,b){var e="";_.has(d,"description")&&""!==d.description&&(e=' title="'+d.description+'" ');var a='<div class="'+tdcSidebarPanel._getParameterClasses(d)+'">';a+='<div class="tdc-property-title"><span class="tdc-search-data"'+e+">"+d.heading+"</span></div>";a=a+'<div class="tdc-property"><div class="tdc-gradient-wrap tdc-no-gradient-selected"></div><input '+(tdcSidebarPanel._getParamterDataAtts(d,b)+
' name="'+tdcSidebarPanel._getParameterDomName(d)+'" type="hidden" value="'+tdcSidebarPanel._getParameterCurrentValue(d,b)+'"/>');a=a+'</div><span class="tdc-param-name">'+(d.param_name+"</span>");a+="</div>";tdcSidebarPanel._hook.hasCallback("panel_rendered",tdcSidebarPanel.callbackGradient)||tdcSidebarPanel._hook.addAction("panel_rendered",tdcSidebarPanel.callbackGradient);return a},callbackGradient:function(){jQuery("#tdc-gradient-color-picker").tdGradient();jQuery(".tdc-property-gradient").each(function(){var d=
jQuery(this),b=d.find("input");d=d.find(".tdc-gradient-wrap");if(!_.isUndefined(b.val())&&""!==b.val())try{var e=JSON.parse(window.atob(b.val()));_.isUndefined(e.css)||d.attr("style",e.css)}catch(a){e=b.val(),_.isUndefined(e)||d.attr("style","background: "+e)}})},addDropDown:function(d,b){if("tdb_mobile_menu"===b.get("tag")&&"menu_id"===d.param_name){var e=b.get("attrs");e.menu_id=window.tdcPostSettings.mobileMenuId;b.set("attrs",e)}var a=e=!1;_.has(d,"tdc_dropdown_images")&&""!==d.tdc_dropdown_images&&
(e=!0);_.has(d,"tdc_dropdown_texts")&&""!==d.tdc_dropdown_texts&&(a=!0);var c="",f="",g=Object.keys(d.value);if(_.has(d,"tdc_min_options")&&g.length<=parseInt(d.tdc_min_options))return c;for(var l=0;l<g.length;l++){var k=!1,h="",n=g[l],p=String(tdcSidebarPanel._getParameterCurrentValue(d,b)),q=String(d.value[g[l]]);_.isObject(d.value[g[l]])&&(k=!0,q=_.values(d.value[g[l]])[0],n=_.keys(d.value[g[l]])[0]);if(e||a){0===l&&""===p&&(p=q);p===q&&(h=" checked ");p=_.uniqueId();var t=q;if("vc_row"===b.attributes.tag||
"vc_row_inner"===b.attributes.tag)t="col_"+t;f+='<input class="tdc-property-input-radio" type="radio" '+tdcSidebarPanel._getParamterDataAtts(d,b)+' id="'+p+'" name="'+tdcSidebarPanel._getParameterDomName(d)+'" '+h+' value="'+q+'">';e?(h="",k&&(h="tdc-standard-value"),f+='<label class="tdc-property-input-radio-label '+h+'" for="'+p+'" title="'+n+'"><div class="'+t+'"></div></label>'):f+='<label class="tdc-property-input-radio-label" for="'+p+'" title="'+n+'">'+q+"</label>"}else p===q&&(h=' selected="selected" '),
f+="<option "+h+' value="'+q+'">'+n+"</option>"}g="";_.has(d,"description")&&""!==d.description&&(g=' title="'+d.description+'" ');c+='<div class="'+tdcSidebarPanel._getParameterClasses(d)+'">';c+='<div class="tdc-property-title"><span class="tdc-search-data"'+g+">"+d.heading+"</span></div>";c+='<div class="tdc-property">';e||a?c+=f:(c+="<select "+tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+'">',c=c+f+"</select>");c=c+'</div><span class="tdc-param-name">'+
(d.param_name+"</span>");return c+"</div>"},addDropDownResponsive:function(d,b){var e=!1,a=!1;_.has(d,"tdc_dropdown_images")&&""!==d.tdc_dropdown_images&&(e=!0);_.has(d,"tdc_dropdown_texts")&&""!==d.tdc_dropdown_texts&&(a=!0);var c="",f="",g=Object.keys(d.value);if(_.has(d,"tdc_min_options")&&g.length<=parseInt(d.tdc_min_options))return c;var l=' data-responsive="" ',k=String(tdcSidebarPanel._getParameterCurrentValue(d,b));try{var h=JSON.parse(window.atob(k));l=' data-responsive="'+k+'" ';"undefined"!==
typeof h[tdcSidebar.currentViewportSettings.name]&&(k=h[tdcSidebar.currentViewportSettings.name])}catch(r){}for(h=0;h<g.length;h++){var n=!1,p="",q=g[h],t=String(d.value[g[h]]);_.isObject(d.value[g[h]])&&(n=!0,t=_.values(d.value[g[h]])[0],q=_.keys(d.value[g[h]])[0]);if(e||a){0===h&&""===k&&(k=t);k===t&&(p=" checked ");var v=_.uniqueId(),u=t;if("vc_row"===b.attributes.tag||"vc_row_inner"===b.attributes.tag)u="col_"+u;f+='<input class="tdc-property-input-radio" type="radio" '+tdcSidebarPanel._getParamterDataAtts(d,
b)+' id="'+v+'" name="'+tdcSidebarPanel._getParameterDomName(d)+'" '+p+' value="'+t+'">';e?(p="",n&&(p="tdc-standard-value"),f+='<label class="tdc-property-input-radio-label '+p+'" for="'+v+'" title="'+q+'"><div class="'+u+'"></div></label>'):f+='<label class="tdc-property-input-radio-label" for="'+v+'" title="'+q+'">'+t+"</label>"}else k===t&&(p=' selected="selected" '),f+="<option "+p+' value="'+t+'">'+q+"</option>"}g="";_.has(d,"description")&&""!==d.description&&(g=' title="'+d.description+'" ');
c+='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(d)+'">';c+='<div class="tdc-property-title"><span class="tdc-search-data"'+g+">"+d.heading+'<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-select" style="display: block;"></div></span></div>';c+='<div class="tdc-property">';e||a?c+=f:(c+="<select "+tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+'" '+l+g+">",c=c+f+"</select>");c=c+'</div><span class="tdc-param-name">'+
(d.param_name+"</span>");return c+"</div>"},addCheckBox:function(d,b){var e="";_.has(d,"description")&&""!==d.description&&(e=' title="'+d.description+'" ');var a="";""!==tdcSidebarPanel._getParameterCurrentValue(d,b)&&(a=" checked ");var c='<div class="'+tdcSidebarPanel._getParameterClasses(d)+'">';c+='<div class="tdc-property-title"><span class="tdc-search-data"'+e+">"+d.heading+"</span></div>";c=c+'<div class="tdc-property"><input '+(tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+
'" type="checkbox" value="yes" '+a+"/>");c=c+'</div><span class="tdc-param-name">'+(d.param_name+"</span>");return c+"</div>"},addCheckBoxResponsive:function(d,b){var e="",a=' data-responsive="" ',c=String(tdcSidebarPanel._getParameterCurrentValue(d,b));try{var f=JSON.parse(window.atob(c));a=' data-responsive="'+c+'" ';"undefined"!==typeof f[tdcSidebar.currentViewportSettings.name]&&(c=f[tdcSidebar.currentViewportSettings.name])}catch(g){}""!==c&&(e=" checked ");f="";_.has(d,"description")&&""!==
d.description&&(f=' title="'+d.description+'" ');c='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(d)+'">';c+='<div class="tdc-property-title"><span class="tdc-search-data"'+f+">"+d.heading+'<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-checkbox" style="display: block;"></div></span></div>';c=c+'<div class="tdc-property"><input '+(tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+'" type="checkbox" value="yes" '+
e+a+"/>");c=c+'</div><span class="tdc-param-name">'+(d.param_name+"</span>");return c+"</div>"},addRange:function(d,b){var e="";_.has(d,"description")&&""!==d.description&&(e=' title="'+d.description+'" ');var a="";_.has(d,"range_max")&&""!==d.range_max&&(a=d.range_max);var c="";_.has(d,"range_min")&&""!==d.range_min&&(c=d.range_min);var f="";_.has(d,"range_step")&&""!==d.range_step&&(f=d.range_step);var g="";_.has(d,"value")&&""!==d.value&&(g=d.value);var l="";""!==tdcSidebarPanel._getParameterCurrentValue(d,
b)&&(l=tdcSidebarPanel._getParameterCurrentValue(d,b));var k='<div class="'+tdcSidebarPanel._getParameterClasses(d)+'">';k+='<div class="tdc-property-title"><span class="tdc-search-data"'+e+">"+d.heading+"</span></div>";k=k+'<div class="tdc-property"><input '+(tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+'" type="range" data-value="'+l+'" data-min="'+c+'" data-max="'+a+'" data-step="'+f+'" min="'+c+'" max="'+a+'" step="'+f+'" value="'+l+'" />');k=k+('<input type="text" class="tdc_range_value" data-default_value="'+
g+'" value="'+l+'"/></div><span class="tdc-param-name">')+(d.param_name+"</span>");return k+="</div>"},addRangeResponsive:function(d,b){var e="";_.has(d,"description")&&""!==d.description&&(e=' title="'+d.description+'" ');var a="";_.has(d,"range_max")&&""!==d.range_max&&(a=d.range_max);var c="";_.has(d,"range_min")&&""!==d.range_min&&(c=d.range_min);var f="";_.has(d,"range_step")&&""!==d.range_step&&(f=d.range_step);var g="";_.has(d,"value")&&""!==d.value&&(g=d.value);""!==tdcSidebarPanel._getParameterCurrentValue(d,
b)&&tdcSidebarPanel._getParameterCurrentValue(d,b);var l="";_.has(d,"placeholder")&&""!==d.placeholder&&(l=' data-placeholder="'+d.placeholder+'" placeholder="'+d.placeholder+'" ');var k=' data-responsive="" ',h=tdcSidebarPanel._getParameterCurrentValue(d,b);try{var n=JSON.parse(window.atob(h));k=' data-responsive="'+h+'" ';h="undefined"===typeof n[tdcSidebar.currentViewportSettings.name]?"":n[tdcSidebar.currentViewportSettings.name]}catch(p){}n='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(d)+
'">';n+='<div class="tdc-property-title"><span class="tdc-search-data"'+e+">"+d.heading+"</span></div>";n=n+'<div class="tdc-property"><input '+(tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+'" type="range" data-value="'+h+'" data-min="'+c+'" data-max="'+a+'" data-step="'+f+'" min="'+c+'" max="'+a+'" step="'+f+'" value="'+h+'" '+k+" />");n=n+('<input type="text" class="tdc_range_value" data-default_value="'+g+'" '+l+' value="'+h+'"/></div><span class="tdc-param-name">')+
(d.param_name+"</span>");return n+="</div>"},addRangeMultiple:function(d,b){var e="";_.has(d,"description")&&""!==d.description&&(e=' title="'+d.description+'" ');var a=d.tdc_values,c=tdcSidebarPanel._getParameterCurrentValue(d,b),f="",g="",l=[],k="",h="",n="",p="",q="",t="",v="",u;for(u in a)a.hasOwnProperty(u)&&(l.push(a[u].unit),""===h||""===k)&&(p=a[u].unit,h=' data-range_unit="'+p+'" ',n=a[u].value,k=' data-range_value="'+n+'" ',q=a[u].range_min,t=a[u].range_max,v=a[u].range_step);if(""!==c){for(var r=
[],w=0;w<l.length&&!(r=c.split(l[w]),1<r.length);w++);r.length&&(p=l[w],h=' data-range_unit="'+p+'" ',n=r[0],k=' data-range_value="'+n+'" ')}for(u in a)a.hasOwnProperty(u)&&(c=_.uniqueId(),f+=" data-value_"+u+'="'+a[u].value+'" ',f+=" data-min_"+u+'="'+a[u].range_min+'" ',f+=" data-max_"+u+'="'+a[u].range_max+'" ',f+=" data-step_"+u+'="'+a[u].range_step+'" ',l=a[u].value,r="",a[u].unit===p&&(l=n,q=a[u].range_min,t=a[u].range_max,v=a[u].range_step,r="checked"),g+='<input name="'+tdcSidebarPanel._getParameterDomName(d)+
'_unit" data-unit="'+u+'" data-unit_value="'+a[u].unit+'" type="radio" id="'+c+'" '+r+' data-default_value="'+a[u].value+'" data-last_value="'+l+'"/>',g+='<label for="'+c+'">'+a[u].unit+"</label>");a='<div class="'+tdcSidebarPanel._getParameterClasses(d)+'">';a+='<div class="tdc-property-title"><span class="tdc-search-data"'+e+">"+d.heading+"</span></div>";a=a+'<div class="tdc-property"><input class="tdc-multiple-range" '+(tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+
'" type="range" '+k+" "+h+" "+f+' min="'+q+'" max="'+t+'" step="'+v+'" value="'+n+'"/>');a=a+'<div class="tdc-multiple-range-wrap"><div class="tdc-multiple-range-value">'+g+'</div><input type="text" class="tdc_range_value" value="'+(n+'"/>');a+="</div>";a+="</div>";a+='<span class="tdc-param-name">'+d.param_name+"</span>";return a+="</div>"},addRangeMultipleResponsive:function(d,b){var e="";_.has(d,"description")&&""!==d.description&&(e=' title="'+d.description+'" ');var a=d.tdc_values,c=tdcSidebarPanel._getParameterCurrentValue(d,
b),f="",g="",l=[],k=' data-responsive="" ',h="",n="",p="",q="",t="",v="",u="",r;for(r in a)a.hasOwnProperty(r)&&(l.push(a[r].unit),""===n||""===h)&&(q=a[r].unit,n=' data-range_unit="'+q+'" ',p=a[r].value,h=' data-range_value="'+p+'" ',t=a[r].range_min,v=a[r].range_max,u=a[r].range_step);if(""!==c){var w=c;try{var A=JSON.parse(window.atob(c));k=' data-responsive="'+c+'" ';w="undefined"===typeof A[tdcSidebar.currentViewportSettings.name]?"":A[tdcSidebar.currentViewportSettings.name]}catch(x){}if(""!==
w){c=[];for(A=0;A<l.length&&!(c=w.split(l[A]),1<c.length);A++);c.length&&(q=l[A],n=' data-range_unit="'+q+'" ',p=c[0],h=' data-range_value="'+p+'" ')}}for(r in a)a.hasOwnProperty(r)&&(l=_.uniqueId(),f+=" data-value_"+r+'="'+a[r].value+'" ',f+=" data-min_"+r+'="'+a[r].range_min+'" ',f+=" data-max_"+r+'="'+a[r].range_max+'" ',f+=" data-step_"+r+'="'+a[r].range_step+'" ',w=a[r].value,c="",a[r].unit===q&&(w=p,t=a[r].range_min,v=a[r].range_max,u=a[r].range_step,c="checked"),g+='<input name="'+tdcSidebarPanel._getParameterDomName(d)+
'_unit" data-unit="'+r+'" data-unit_value="'+a[r].unit+'" type="radio" id="'+l+'" '+c+' data-default_value="'+a[r].value+'" data-last_value="'+w+'"/>',g+='<label for="'+l+'">'+a[r].unit+"</label>");a='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(d)+'">';a+='<div class="tdc-property-title"><span class="tdc-search-data"'+e+">"+d.heading+"</span></div>";a=a+'<div class="tdc-property"><input class="tdc-multiple-range" '+(tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+
tdcSidebarPanel._getParameterDomName(d)+'" type="range" '+h+" "+n+" "+f+" "+k+' min="'+t+'" max="'+v+'" step="'+u+'" value="'+p+'"/>');a=a+'<div class="tdc-multiple-range-wrap"><div class="tdc-multiple-range-value">'+g+'</div><input type="text" class="tdc_range_value" value="'+(p+'"/>');a+="</div>";a+="</div>";a+='<span class="tdc-param-name">'+d.param_name+"</span>";return a+="</div>"},addIconSelector:function(d,b){var e="";_.has(d,"description")&&""!==d.description&&(e=' title="'+d.description+
'" ');var a='<div class="'+tdcSidebarPanel._getParameterClasses(d)+'">';a+='<div class="tdc-property-title"><span class="tdc-search-data"'+e+">"+d.heading+"</span></div>";a=a+'<div class="tdc-property"><div class="tdc-icon-wrap tdc-no-icon-selected" '+(tdcSidebarPanel._getParamterDataAtts(d,b)+">");a=a+'</div><a class="tdc-icon-remove tdc-hidden-button" href="#" >Remove</a></div><span class="tdc-param-name">'+(d.param_name+"</span>");a+="</div>";tdcSidebarPanel._hook.addAction("panel_rendered",function(){jQuery(".tdc-icon-wrap").each(function(a,
e){var c=jQuery(e);if(d.param_name===c.data("param_name")){var f=tdcSidebarPanel._getParameterCurrentValue(d,b);""!==f&&(c.html('<i class="'+f+'"></i>'),c.closest(".tdc-property").find(".tdc-icon-remove").removeClass("tdc-hidden-button"))}})});return a},addUploadImage:function(d,b){var e="";_.has(d,"description")&&""!==d.description&&(e=' title="'+d.description+'" ');var a='<div class="'+tdcSidebarPanel._getParameterClasses(d)+'">';a+='<div class="tdc-property-title"><span class="tdc-search-data"'+
e+">"+d.heading+"</span></div>";a=a+'<div class="tdc-property"><div class="tdc-image-wrap tdc-no-image-selected" '+(tdcSidebarPanel._getParamterDataAtts(d,b)+" style=\"background-image: url('"+window.tdcAdminSettings.pluginUrl+"/assets/images/sidebar/no_img.png')\">");a=a+'</div><a class="tdc-image-remove tdc-hidden-button" href="#" >Remove</a></div><span class="tdc-param-name">'+(d.param_name+"</span>");a+="</div>";tdcSidebarPanel._hook.addAction("panel_rendered",function(){jQuery(".tdc-image-wrap").each(function(a,
e){var c=jQuery(e);if(!c.parent().parent(".tdc-bg-upload").length&&d.param_name===c.data("param_name")){var f=tdcSidebarPanel._getParameterCurrentValue(d,b);""!==f&&jQuery.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/get_image_url","uuid="+tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},dataType:"json",data:{image_id:f,action:"tdc_ajax_get_image_url"}}).done(function(a,b,e){"success"===b&&(_.isObject(a)&&
_.has(a,"errors")?new tdcNotice.notice(a.errors,!0,!1):(c.attr("style","background-image: url('"+a.image_url+"')").removeClass("tdc-no-image-selected"),c.data("image_link",a.image_url),c.data("image_id",f),c.closest(".tdc-property").find(".tdc-image-remove").removeClass("tdc-hidden-button")))}).fail(function(a,c,b){})}})});return a},addTextField:function(d,b){var e="",a="";if(_.has(d,"description")&&""!==d.description){var c=jQuery("<div>"+d.description+"</div>");d.description===c.text()?e=' title="'+
d.description+'" ':a='<div class="tdc-description">'+d.description+"</div>"}c="";_.has(d,"placeholder")&&""!==d.placeholder&&(c=' data-placeholder="'+d.placeholder+'" placeholder="'+d.placeholder+'" ');var f='<div class="'+tdcSidebarPanel._getParameterClasses(d)+'">';f+='<div class="tdc-property-title"><span class="tdc-search-data"'+e+">"+d.heading+"</span></div>";f=f+'<div class="tdc-property"><input '+(tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+'" type="text" '+
c+' value="'+tdcSidebarPanel._getParameterCurrentValue(d,b)+'"/>');f=f+a+'</div><span class="tdc-param-name">'+(d.param_name+"</span>");return f+="</div>"},addDoShortcode:function(d,b){var e=_.uniqueId("tdc_textarea_"),a="";_.has(d,"description")&&""!==d.description&&(a=' title="'+d.description+'" ');var c='<div class="'+tdcSidebarPanel._getParameterClasses(d)+'">';c+='<div class="tdc-property-title"><span'+a+">"+d.heading+"</span></div>";c=c+'<div class="tdc-property"><textarea id="'+(e+'" class="tdc-textarea tdc-textarea-visible" '+
tdcSidebarPanel._getParamterDataAtts(d,b)+">"+decodeURIComponent(atob(tdcSidebarPanel._getParameterCurrentValue(d,b)))+"</textarea>");c=c+'</div><span class="tdc-param-name">'+(d.param_name+"</span>");c+="</div>";a=jQuery("body");a.on("change","#woo_shortcode",function(a){jQuery(a.change);a=atob(a.target.value);jQuery("#"+e).val(a).trigger("focusin")});a.on("keyup focusin","#"+e,function(a){var c=jQuery(a.target),b=tdcIFrameData.getModel(c.data("model_id")),e=window.btoa(encodeURIComponent(c.val())),
d=window.btoa(encodeURIComponent(a.target.oldValue));setTimeout(function(){tdcSidebarController.onUpdate(b,c.data("param_name"),d,e)},500)});return c},addTextFieldResponsive:function(d,b){var e="",a="";if(_.has(d,"description")&&""!==d.description){var c=jQuery("<div>"+d.description+"</div>");d.description===c.text()?e=' title="'+d.description+'" ':a='<div class="tdc-description">'+d.description+"</div>"}c="";_.has(d,"placeholder")&&""!==d.placeholder&&(c=' data-placeholder="'+d.placeholder+'" placeholder="'+
d.placeholder+'" ');var f=' data-responsive="" ',g=tdcSidebarPanel._getParameterCurrentValue(d,b);try{var l=JSON.parse(window.atob(g));f=' data-responsive="'+g+'" ';g="undefined"===typeof l[tdcSidebar.currentViewportSettings.name]?"":l[tdcSidebar.currentViewportSettings.name]}catch(k){}l='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(d)+'">';l+='<div class="tdc-property-title"><span class="tdc-search-data"'+e+">"+d.heading+"</span></div>";l=l+'<div class="tdc-property"><input '+
(tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+'" type="text" value="'+g+'" '+c+f+e+"/>");l=l+a+'</div><span class="tdc-param-name">'+(d.param_name+"</span>");return l+="</div>"},addTextAreaHtml:function(d,b){_.has(d,"description");return'<a href="#" class="tdc-open-wpeditor" data-model_id="'+b.cid+'" data-mapped_parameter_name="'+d.param_name+'">Edit Content</a>'},addTextAreaRawHtml:function(d,b){var e=_.uniqueId("tdc_textarea_"),a="";_.has(d,"description")&&
""!==d.description&&(a=' title="'+d.description+'" ');var c='<div class="'+tdcSidebarPanel._getParameterClasses(d)+'">';c+='<div class="tdc-property-title"><span class="tdc-search-data"'+a+">"+d.heading+"</span></div>";c=c+'<div class="tdc-property"><textarea id="'+(e+'" class="tdc-textarea" '+tdcSidebarPanel._getParamterDataAtts(d,b)+">"+tdcSidebarPanel._getParameterCurrentValue(d,b)+"</textarea>");c=c+'</div><span class="tdc-param-name">'+(d.param_name+"</span>");c+="</div>";jQuery.ajax({timeout:1E4,
type:"POST",url:tdcUtil.getRestEndPoint("td-composer/decode_html_content","uuid="+tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},dataType:"json",data:{post_id:window.tdcPostSettings.postId,action:"tdc_ajax_decode_html_content",content:tdcSidebarPanel._getParameterCurrentValue(d,b)}}).done(function(a,c,b){"success"===c&&(_.isObject(a)&&_.has(a,"errors")?new tdcNotice.notice(a.errors,!0,!1):jQuery("#"+e).html(a.parsed_content).addClass("tdc-textarea-visible"))}).fail(function(a,
c,b){});jQuery("body").on("keyup focusin","#"+e,function(a){var c=jQuery(a.target),b=tdcIFrameData.getModel(c.data("model_id"));if("focusin"!==a.type&&a.target.oldValue!==a.target.value){var e=window.btoa(encodeURIComponent(c.val())),d=window.btoa(encodeURIComponent(a.target.oldValue));tdcSidebarController.onUpdate(b,c.data("param_name"),d,e)}a.target.oldValue=a.target.value});return c},addSeparatorHorizontal:function(d,b){return'<div class="tdc-sidebar-horizontal-separator '+tdcSidebarPanel._getParameterClasses(d)+
'"></div>'},addTextSeparatorHorizontal:function(d,b){return'<div class="tdc-sidebar-text-separator tdc-property-title '+tdcSidebarPanel._getParameterClasses(d)+'"><span class="tdc-search-data">'+d.heading+"</span></div>"},addFontHeader:function(d,b){return'<div class="tdc-sidebar-font-header '+tdcSidebarPanel._getParameterClasses(d)+'"><span class="tdc-font-ico1" title="Font size"></span><span class="tdc-font-ico2" title="Line height (Use with px or a number that will be multiplied with the current font-size)"></span><span class="tdc-font-ico3" title="Font style"></span><span class="tdc-font-ico4" title="Font weight"></span><span class="tdc-font-ico5" title="Text transform"></span><span class="tdc-font-ico6" title="Letter spacing"></span></div>'},
...
addShadowTitle:function(d,b){return'<div class="tdc-sidebar-shadow-title '+tdcSidebarPanel._getParameterClasses(d)+'"><span class="tdc-search-data">'+tdcSidebarPanel._getParameterCurrentValue(d,b)+"</span></div>"},addSpotHeader:function(d,b){var e='<div class="tdc-spot-header '+tdcSidebarPanel._getParameterClasses(d)+'">';e="undefined"!==typeof d.inline_spot&&!0===d.inline_spot?e+'<span class="tdc-inline-spot-header-title">Title</span><span class="tdc-inline-spot-header-paragraph">Par.</span><span class="tdc-inline-spot-header-color">Color</span><span class="tdc-inline-spot-header-align">Align</span>':
e+'<span class="tdc-spot-header-title">Title</span><span class="tdc-spot-header-color">Color</span>';return e+"</div>"},addClearfix:function(d,b){return'<div class="clearfix"></div>'},updateTextfieldResponsiveValues:function(d,b,e){"undefined"===typeof window.tdcResponsiveValues[d]?""!==b&&(window.tdcResponsiveValues[d]={},window.tdcResponsiveValues[d][e]={viewportName:b}):""===b?delete window.tdcResponsiveValues[d][e]:window.tdcResponsiveValues[d][e]=b;b=_.allKeys(window.tdcResponsiveValues[d]);
...
b.length||1===b.length&&"all"!==b[0]?window.btoa(JSON.stringify(window.tdcResponsiveValues[d])):""},updateCheckboxResponsiveValues:function(d,b,e){"undefined"===typeof window.tdcResponsiveValues[d]?(window.tdcResponsiveValues[d]={},window.tdcResponsiveValues[d][e]={viewportName:b}):window.tdcResponsiveValues[d][e]=b;b=_.allKeys(window.tdcResponsiveValues[d]);return 1===b.length&&"all"===b[0]?window.tdcResponsiveValues[d].all:1<b.length||1===b.length&&"all"!==b[0]?window.btoa(JSON.stringify(window.tdcResponsiveValues[d])):
...
l),d.val(c),h=e.find('input[type="radio"][data-unit_value="'+l+'"]'),k=h.data("unit"),f=d.data("min_"+k),l=d.data("max_"+k),k=d.data("step_"+k),g=d.get(0),h.prop("checked",!0),g.min=f,g.max=l,g.step=k,g.value=c,h.data("last_value",c),e.find('input[type="text"]').val(c))}}},showShortcodeFromPath:function(d){if(!_.isUndefined(d)){d=d.toString().split("_");var b;d.forEach(function(a,e){if(""!==a)if(_.isUndefined(b))b=tdcIFrameData.tdcTopCollection.at(a);else{var c=b.get("childCollection");!_.isUndefined(c)&&
c.length>a&&(b=c.at(a))}});if(!_.isUndefined(b)){var e=b.get("blockUid");if(!_.isUndefined(e)){var a=tdcAdminIFrameUI.getLiveIframe();d=a.contents().find("#"+e);d.length||(d=a.contents().find('[data-td-block-uid="'+e+'"]'));d.length&&(a.contents().scrollTop(d.offset().top-100),e={},tdcOperationUI.inZone(d)?tdcOperationUI.inRow(d)?tdcOperationUI.inColumn(d)?tdcOperationUI.inInnerRow(d)?tdcOperationUI.inInnerColumn(d)?(e.$currentZone=tdcOperationUI.inZone(d),e.$currentRow=tdcOperationUI.inRow(d),e.$currentColumn=
tdcOperationUI.inColumn(d),e.$currentInnerRow=tdcOperationUI.inInnerRow(d),e.$currentInnerColumn=tdcOperationUI.inInnerColumn(d),e.$currentElement=d):(e.$currentZone=tdcOperationUI.inZone(d),e.$currentRow=tdcOperationUI.inRow(d),e.$currentColumn=tdcOperationUI.inColumn(d),e.$currentInnerRow=tdcOperationUI.inInnerRow(d),e.$currentInnerColumn=d):(e.$currentZone=tdcOperationUI.inZone(d),e.$currentRow=tdcOperationUI.inRow(d),e.$currentColumn=tdcOperationUI.inColumn(d),e.$currentInnerRow=d):(e.$currentZone=
tdcOperationUI.inZone(d),e.$currentRow=tdcOperationUI.inRow(d),e.$currentColumn=d):(e.$currentZone=tdcOperationUI.inZone(d),e.$currentRow=d):e.$currentZone=d,tdcSidebar._currentModel=b,d.data("model_id",b.cid),tdcSidebar.setSettings(e,!0,b))}}}}}})();var tdcSidebar;
...
tdcSidebar.$_palette=tdcSidebar.$_sidebar.find("#tdc-palette");tdcSidebar._paletteOuterHTML=tdcSidebar.$_palette.get(0).outerHTML;tdcSidebar._fontListOuterHTML=tdcSidebar.$_sidebar.find("#tdc-font-list").get(0).outerHTML;tdcSidebar.$_buttonZone=tdcSidebar.$_sidebar.find(".tdc-zone-button");tdcSidebar.$_tdcZone=f("#tdc-zone");tdcSidebar.$_headerTemplateZones=tdcSidebar.$_tdcZone.find(".tdc-header-template-zones");tdcSidebar.$_headerTemplateList=tdcSidebar.$_tdcZone.find(".tdc-header-template-list");
tdcSidebar.$_footerTemplateList=tdcSidebar.$_tdcZone.find(".tdc-footer-template-list");window.tdcAdminSettings.tdbHeaderTemplates.forEach(function(b){tdcSidebar.$_headerTemplateList.append('<option value="'+b.val+'">'+b.text+"</option>")});window.tdcAdminSettings.tdbFooterTemplates.forEach(function(b){tdcSidebar.$_footerTemplateList.append('<option value="'+b.val+'">'+b.text+"</option>")});tdcState.isGlobalTemplate()?tdcSidebar.$_headerTemplateList.find("option:first").attr("selected",!0):tdcState.isNoHeader()?
tdcSidebar.$_headerTemplateList.find('option[value="no_header"]').attr("selected",!0):tdcSidebar.$_headerTemplateList.find('option[value="tdb_template_'+tdcState.getHeaderTemplateId()+'"]').attr("selected",!0);tdcState.isGlobalFooterTemplate()?tdcSidebar.$_footerTemplateList.find("option:first").attr("selected",!0):tdcState.isNoFooter()?tdcSidebar.$_footerTemplateList.find('option[value="no_footer"]').attr("selected",!0):tdcSidebar.$_footerTemplateList.find('option[value="tdb_template_'+tdcState.getFooterTemplateId()+
'"]').attr("selected",!0);tdcSidebar.$_buttonZone.click(function(){tdcSidebar.$_tdcZone.show();tdcWindowFrame.setWindowFrame(tdcSidebar.$_tdcZone)});tdcSidebar.$_tdcZone.on("click",".tdc-zone-icon",function(e){e=f(this).parent();var a=e.data("type");tdcSidebar.$_tdcZone.find(".tdc-zone").removeClass("tdc-zone-active");e.addClass("tdc-zone-active");"tdc_header_desktop_sticky"===a||"tdc_header_mobile_sticky"===a?(tdcIFrameData.activateZone(a,!0,!0),e.addClass("tdc-zone-sticky-active"),e.removeClass("tdc-zone-sticky-inactive"),
"tdc_header_desktop_sticky"===a?e.hasClass("tdc-zone-sticky-active")?tdcState.setHeaderSticky():tdcState.unsetHeaderSticky():e.hasClass("tdc-zone-sticky-active")?tdcState.setMobileHeaderSticky():tdcState.unsetMobileHeaderSticky()):tdcIFrameData.activateZone(a,b,!0)}).on("click",".tdc-zone-sticky-info",function(e){e=f(this).parent();var a=e.data("type");tdcSidebar.$_tdcZone.find(".tdc-zone").removeClass("tdc-zone-active");e.addClass("tdc-zone-active");"tdc_header_desktop_sticky"===a||"tdc_header_mobile_sticky"===
a?(e.hasClass("tdc-zone-sticky-inactive")?tdcIFrameData.activateZone(a,!0,!0):tdcIFrameData.activateZone(a,!1),e.toggleClass("tdc-zone-sticky-active"),e.toggleClass("tdc-zone-sticky-inactive"),"tdc_header_desktop_sticky"===a?e.hasClass("tdc-zone-sticky-active")?tdcState.setHeaderSticky():tdcState.unsetHeaderSticky():e.hasClass("tdc-zone-sticky-active")?tdcState.setMobileHeaderSticky():tdcState.unsetMobileHeaderSticky()):tdcIFrameData.activateZone(a,b,!0)}).on("change",".tdc-header-template-list",
function(b){b=f(this);tdcSidebar.getHeaderTemplate(b.val().replace("tdb_template_",""))}).on("change",".tdc-footer-template-list",function(b){b=f(this);tdcSidebar.getFooterTemplate(b.val().replace("tdb_template_",""))}).find(".tdc-zone").each(function(){var b=f(this),a=b.data("type");if(!d.isUndefined(a))switch(a){case "tdc_header_desktop_sticky":tdcState.isHeaderSticky()?b.addClass("tdc-zone-sticky-active").removeClass("tdc-zone-sticky-inactive"):b.addClass("tdc-zone-sticky-inactive").removeClass("tdc-zone-sticky-active");
break;case "tdc_header_mobile_sticky":tdcState.isMobileHeaderSticky()?b.addClass("tdc-zone-sticky-active").removeClass("tdc-zone-sticky-inactive"):b.addClass("tdc-zone-sticky-inactive").removeClass("tdc-zone-sticky-active")}});tdcSidebar.$_editZone.click(function(){tdcSidebar.setSettings({$currentZone:tdcSidebar.getCurrentZone()})}).mouseenter(function(b){d.isUndefined(tdcSidebar._$currentElement)||(tdcMaskUI.setCurrentElement(tdcSidebar._$currentElement),tdcMaskUI.$wrapper.hide());d.isUndefined(tdcSidebar._$currentZone)||
tdcMaskUI.setCurrentContainer(tdcSidebar._$currentZone)}).mouseleave(function(b){tdcMaskUI.hide()});tdcSidebar.$_editRow.click(function(){tdcSidebar.setSettings({$currentZone:tdcSidebar.getCurrentZone(),$currentRow:tdcSidebar.getCurrentRow()})}).mouseenter(function(b){d.isUndefined(tdcSidebar._$currentElement)||(tdcMaskUI.setCurrentElement(tdcSidebar._$currentElement),tdcMaskUI.$wrapper.hide());d.isUndefined(tdcSidebar._$currentRow)||tdcMaskUI.setCurrentContainer(tdcSidebar._$currentRow)}).mouseleave(function(b){tdcMaskUI.hide()});
tdcSidebar.$_editColumn.click(function(){tdcSidebar.setSettings({$currentZone:tdcSidebar.getCurrentZone(),$currentRow:tdcSidebar.getCurrentRow(),$currentColumn:tdcSidebar.getCurrentColumn()})}).mouseenter(function(b){d.isUndefined(tdcSidebar._$currentElement)||(tdcMaskUI.setCurrentElement(tdcSidebar._$currentElement),tdcMaskUI.$wrapper.hide());d.isUndefined(tdcSidebar._$currentColumn)||tdcMaskUI.setCurrentContainer(tdcSidebar._$currentColumn)}).mouseleave(function(b){tdcMaskUI.hide()});tdcSidebar.$_editInnerRow.click(function(){tdcSidebar.setSettings({$currentZone:tdcSidebar.getCurrentZone(),
$currentRow:tdcSidebar.getCurrentRow(),$currentColumn:tdcSidebar.getCurrentColumn(),$currentInnerRow:tdcSidebar.getCurrentInnerRow()})}).mouseenter(function(b){d.isUndefined(tdcSidebar._$currentElement)||(tdcMaskUI.setCurrentElement(tdcSidebar._$currentElement),tdcMaskUI.$wrapper.hide());d.isUndefined(tdcSidebar._$currentInnerRow)||tdcMaskUI.setCurrentContainer(tdcSidebar._$currentInnerRow)}).mouseleave(function(b){tdcMaskUI.hide()});tdcSidebar.$_editInnerColumn.click(function(){tdcSidebar.setSettings({$currentZone:tdcSidebar.getCurrentZone(),
$currentRow:tdcSidebar.getCurrentRow(),$currentColumn:tdcSidebar.getCurrentColumn(),$currentInnerRow:tdcSidebar.getCurrentInnerRow(),$currentInnerColumn:tdcSidebar.getCurrentInnerColumn()})}).mouseenter(function(b){d.isUndefined(tdcSidebar._$currentElement)||(tdcMaskUI.setCurrentElement(tdcSidebar._$currentElement),tdcMaskUI.$wrapper.hide());d.isUndefined(tdcSidebar._$currentInnerColumn)||tdcMaskUI.setCurrentContainer(tdcSidebar._$currentInnerColumn)}).mouseleave(function(b){tdcMaskUI.hide()});f(".tdc-sidebar-element").each(function(b,
a){tdcSidebar._bindElement(f(a))});tdcSidebar.$_sidebarClosePage.click(function(d){var a=window.tdcAdminSettings.previousUrl.split("#");!tdcSidebar.$_sidebarClosePage.hasClass("tdb-close-page")&&tdcMain.getContentModified()?tdConfirm.showModal("Close tagDiv Composer?",tdcSidebar,function(){window.onbeforeunload=null;window.location=a[0];tb_remove()},b,"Unsaved content. Still want to close tagDiv Composer?"):(window.onbeforeunload=null,window.location=a[0])});"1"===window.localStorage.getItem("tdc_live_iframe_wrapper_inline")&&
...
b){var c=f(b);c.nextUntil(".tdc-sidebar-separator").is(":visible")?c.show():c.hide()})});tdcSidebar.$_sidebar.on("mouseenter",function(){tdcSidebar.mouseOverSidebar=!0}).on("mouseleave",function(){tdcSidebar.mouseOverSidebar=!1});f("body").css("overflow","hidden");tdcSidebar._sidebarModal();tdcSidebar._liveInspectorTabs();tdcSidebar.updateSavedShortcodes();tdcSidebar.editTemplateName();tdcSidebarPanel.init()},hideWpeditor:function(){f("#tdc-wpeditor").hide()},setForcedHeaderZone:function(b){tdcSidebar._forcedHeaderZone=
...
a=b.get("tag"),c=tdcIFrameData.getZoneParent(b).get("type_zone"),m="<span>"+window.tdcPostSettings.shortcodes[b.get("tag")]+"</span>",g="";tdcSidebar.changeZoneName(c);for(var l in window.tdcAdminSettings.mappedShortcodes)"undefined"===typeof window.tdcAdminSettings.mappedShortcodes[l].tdc_category||"Blocks"!==window.tdcAdminSettings.mappedShortcodes[l].tdc_category&&"Big Grids"!==window.tdcAdminSettings.mappedShortcodes[l].tdc_category||window.tdcAdminSettings.mappedShortcodes[l].tdc_category!==
window.tdcAdminSettings.mappedShortcodes[a].tdc_category||(c="",l===a&&(c="tdc-selected-option"),g+='<li class="'+c+'" data-block_type="'+window.tdcAdminSettings.mappedShortcodes[l].base+'"><div class="tdc-element-ico tdc-ico-'+window.tdcAdminSettings.mappedShortcodes[l].base+'"></div><div class="tdc-element-id">'+window.tdcAdminSettings.mappedShortcodes[l].name+"</div></li>");""!==g?(g="<ul>"+g+"</ul>",tdcSidebar.$_currentElementHead.addClass("tdc-block-selection")):tdcSidebar.$_currentElementHead.removeClass("tdc-block-selection");
switch(a){case "tdc_zone":tdcSidebar.$_editZone.show();tdcSidebar.$_editRow.hide();tdcSidebar.$_editColumn.hide();tdcSidebar.$_editInnerRow.hide();tdcSidebar.$_editInnerColumn.hide();var k=tdcSidebar.$_editZone;break;case "vc_row":tdcSidebar.$_editZone.show();tdcSidebar.$_editRow.hide();tdcSidebar.$_editColumn.hide();tdcSidebar.$_editInnerRow.hide();tdcSidebar.$_editInnerColumn.hide();k=tdcSidebar.$_editRow;break;case "vc_column":tdcSidebar.$_editZone.show();tdcSidebar.$_editRow.show();tdcSidebar.$_editColumn.hide();
tdcSidebar.$_editInnerRow.hide();tdcSidebar.$_editInnerColumn.hide();k=tdcSidebar.$_editColumn;break;case "vc_row_inner":tdcSidebar.$_editZone.show();tdcSidebar.$_editRow.show();tdcSidebar.$_editColumn.show();tdcSidebar.$_editInnerRow.hide();tdcSidebar.$_editInnerColumn.hide();k=tdcSidebar.$_editInnerRow;break;case "vc_column_inner":tdcSidebar.$_editZone.show();tdcSidebar.$_editRow.show();tdcSidebar.$_editColumn.show();tdcSidebar.$_editInnerRow.show();tdcSidebar.$_editInnerColumn.hide();k=tdcSidebar.$_editInnerColumn;
break;default:tdcSidebar.$_editZone.show(),tdcSidebar.$_editRow.show(),tdcSidebar.$_editColumn.show(),k=tdcSidebar.getCurrentElement(),"vc_column_inner"===b.get("parentModel").get("tag")?(tdcSidebar.$_editInnerRow.show(),tdcSidebar.$_editInnerColumn.show()):(tdcSidebar.$_editInnerRow.hide(),tdcSidebar.$_editInnerColumn.hide())}tdcSidebar.$_currentElementHead.html(m);tdcSidebar.$_currentElementSiblings.html(g);tdcSidebar.$_sidebar.find(".tdc-responsiveness").addClass(a);tdcSidebar.$_currentElementHead.off().mouseenter(function(a){a.preventDefault();
k.trigger(a)}).mouseleave(function(a){a.preventDefault();k.trigger(a)}).mousedown(function(a){""!==g&&(tdcSidebar.$_currentElementSiblings.toggleClass("tdc-current-element-siblings-visible"),a=f(this),tdcSidebar.$_currentElementSiblings.hasClass("tdc-current-element-siblings-visible")?a.addClass("tdc-current-element-siblings-button-on"):a.removeClass("tdc-current-element-siblings-button-on"))});tdcSidebar.$_currentElementSiblings.find("li").off().click(function(a){a=f(this);var c=a.data("block_type"),
e=a.children(".tdc-element-id").html();a.siblings(".tdc-selected-option").removeClass("tdc-selected-option");a.addClass("tdc-selected-option");tdcSidebar.$_currentElementHead.html("<span>"+e+"</span>");d.isUndefined(c)||(b.set("tag",c),b.set("rebindToPanel",!0),tdcSidebarController.onUpdate(b));tdcSidebar.$_currentElementSiblings.removeClass("tdc-current-element-siblings-visible")});tdcSidebar.$_currentElementSiblings.mouseleave(function(a){tdcSidebar.$_currentElementSiblings.removeClass("tdc-current-element-siblings-visible")});
tdcSidebar.$_inspector.show()},closeModals:function(){f(".tdc-sidebar-modal").each(function(b,a){var c=f(a),d=c.data("button_class");c.removeClass("tdc-modal-open");"undefined"!==typeof d&&""!==d&&(c=f("."+d),c.length&&c.removeClass("tdc-window-open"))})},_sidebarModal:function(){f(".tdc-add-element").click(function(){f(this).toggleClass("tdc-window-open");f(".tdc-sidebar-modal").each(function(b,a){var c=f(a),d=c.data("button_class");c.hasClass("tdc-sidebar-modal-elements")?(c.toggleClass("tdc-modal-open"),
...
window.tdcAdminSettings.wpRestNonce)},data:{}}).done(function(b,a,c){f(".tdc-save-page").removeClass("tdc-saving-loader");"success"===a&&d.isObject(b)&&(d.has(b,"errors")?new tdcNotice.notice(b.errors,!0,!1):d.has(b,"tdb_header_templates")&&b.tdb_header_templates.forEach(function(a){var c="";if(""!==tdcState.getHeaderTemplateId()&&"no_header"!==tdcState.getHeaderTemplateId()&&parseInt(tdcState.getHeaderTemplateId())===parseInt(a.id)||"no_header"===tdcState.getHeaderTemplateId()&&tdcState.getHeaderTemplateId()===
a.id)c="selected";a=f('<option value="tdb_template_'+a.id+'" '+c+">"+a.title+"</option>");tdcSidebar.$_headerTemplateList.append(a)}))}).fail(function(b,a,c){})},getHeaderTemplate:function(b){f.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/get_header_template","uuid="+tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},data:{td_magic_token:tdcLivePanel.$token.val(),tdc_action:"get_header_template",tdc_header_template_id:b}}).done(function(a,
c,b){"success"===c&&d.isObject(a)&&(d.has(a,"errors")?new tdcNotice.notice(a.errors,!0,!1):(a.global_template?tdcState.setGlobalTemplate():tdcState.unsetGlobalTemplate(),a.no_header?(tdcState.setNoHeader(),tdcState.setHeaderTemplateId("no_header"),tdcState.setHeaderTemplateContent("")):(tdcState.unsetNoHeader(),tdcState.setHeaderTemplateId(a.template_id),tdcState.setHeaderTemplateContent(a.template_content)),tdcIFrameData.setHeaderTemplate(a.template_content)))}).fail(function(a,b,d){})},updateFooterTemplates:function(){tdcSidebar.$_footerTemplateList.find("option").each(function(b){b=
f(this);""!==b.val()&&"no_footer"!==b.val()&&b.remove()});f.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/get_footer_templates","uuid="+tdcJobManager._getUniqueID()),beforeSend:function(b){b.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},data:{}}).done(function(b,a,c){f(".tdc-save-page").removeClass("tdc-saving-loader");"success"===a&&d.isObject(b)&&(d.has(b,"errors")?new tdcNotice.notice(b.errors,!0,!1):d.has(b,"tdb_footer_templates")&&b.tdb_footer_templates.forEach(function(a){var b=
"";if(""!==tdcState.getFooterTemplateId()&&"no_header"!==tdcState.getFooterTemplateId()&&parseInt(tdcState.getFooterTemplateId())===parseInt(a.id)||"no_footer"===tdcState.getFooterTemplateId()&&tdcState.getFooterTemplateId()===a.id)b="selected";a=f('<option value="tdb_template_'+a.id+'" '+b+">"+a.title+"</option>");tdcSidebar.$_footerTemplateList.append(a)}))}).fail(function(b,a,c){})},getFooterTemplate:function(b){f.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/get_footer_template",
"uuid="+tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},data:{td_magic_token:tdcLivePanel.$token.val(),tdc_action:"get_footer_template",tdc_footer_template_id:b}}).done(function(a,b,e){"success"===b&&d.isObject(a)&&(d.has(a,"errors")?new tdcNotice.notice(a.errors,!0,!1):(a.global_template?tdcState.setGlobalFooterTemplate():tdcState.unsetGlobalFooterTemplate(),a.no_footer?(tdcState.setNoFooter(),tdcState.setFooterTemplateId("no_footer"),
tdcState.setFooterTemplateContent("")):(tdcState.unsetNoFooter(),tdcState.setFooterTemplateId(a.template_id),tdcState.setFooterTemplateContent(a.template_content)),tdcIFrameData.setFooterTemplate(a.template_content)))}).fail(function(a,b,d){})}};tdcSidebar.init()})(jQuery,_);var tdcSidebarController={};
...
for(c=0;c<a.params.length;c++)if(a.params[c].param_name===b)return a.params[c];if(0===b.indexOf("tds_")){c=b.split("-");var m=e=f;a=f;2>c.length?new tdcNotice.notice('Param "'+b+'" must have up at least one "-" separator',!0,!1):2===c.length?e=c[0]:3===c.length?(e=c[0],a=c[2]):3<c.length&&new tdcNotice.notice('Param "'+b+'" must have up to at most two "-" separator',!0,!1);if(_.isUndefined(m))for(var g in window.tdcAdminSettings.settingsStyle){if(!_.isUndefined(m))break;for(var l in window.tdcAdminSettings.settingsStyle[g])if(l===
e){m=g;break}}_.isUndefined(e)&&(e=window.tdcAdminSettings.globalStyle[m]);g=window.tdcAdminSettings.settingsStyle[m][e];for(c=0;c<g.params.length;c++)if(l=e+"-"+g.params[c].param_name,_.isUndefined(a)||(l+="-"+a),l===b)return d=JSON.parse(JSON.stringify(g.params[c])),d.param_name=e+"-"+d.param_name,_.isUndefined(a)||(d.param_name+="-"+a),d}new tdcNotice.notice("Map value not found for "+d+" "+b,!0,!1);return f},onUpdate:function(d,b,e,a){var c=new tdcSidebarController._updateJob;c.model=d;c.paramName=
...
f(".media-menu .media-menu-item:nth-of-type(3)").addClass("hidden");f(".media-menu .media-menu-item:nth-of-type(4)").addClass("hidden");window.send_to_editor=function(b){var e=f("img",b).attr("src"),l="";"undefined"===typeof e?(e=f(b).attr("src"),l=f(b).attr("class")):l=f("img",b).attr("class");f.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/get_image_id","uuid="+tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},
dataType:"json",data:{image_class:l,action:"tdc_ajax_get_image_id"}}).done(function(b,g,f){if("success"===g)if(d.isObject(b)&&d.has(b,"errors"))new tdcNotice.notice(b.errors,!0,!1);else{g=a.closest(".tdc-property-wrap");f=g.find(".tdc-css-image-remove");var l=g.find(".tdc-inherit-image");f.removeClass("tdc-hidden-button");"all"===tdcSidebar.currentViewportSettings.name?l.hide():l.show();a.attr("style","background-image: url( '"+e+"') ");a.data("image_link",e);a.data("image_id",b.image_id);window.send_to_editor=
window.original_send_to_editor;window.tb_remove();g.removeClass(tdcCssEditor._INHERITED_CSS_CLASS);"undefined"===typeof a.data("model_id")?tdcCssEditor.saveWidgetForm(a):(b=tdcCssEditor._generateCssAttValue(c),g=tdcIFrameData.getModel(a.data("model_id")),tdcSidebarController.onUpdate(g,a.data("param_name"),"",b))}}).fail(function(a,b,c){})};return!1},tdcCssImageRemoveHandler:function(b){var a=f(b.currentTarget),c=a.closest(".tdc-property-wrap");b=c.find(".tdc-css-image-wrap");var e=c.find(".tdc-inherit-image");
...
e.show());d.isUndefined(c)?(g.val(g.find("option:first").val()),e.hide()):g.val(c);tdcCssEditor._updateData(g)},_inheritColor:function(e){e=f(e.currentTarget);var a=e.closest(".tdc-property-wrap"),c=a.find("input"),m=a.find(".tdc-colorpicker-wrap"),g=a.data("tdc-for");d.isUndefined(tdcCssEditor._currentCssSettings[tdcSidebar.currentViewportSettings.name][g])||delete tdcCssEditor._currentCssSettings[tdcSidebar.currentViewportSettings.name][g];c.data("no_value",0);var l={isInherited:!1};g=tdcCssEditor._getSettingsProperty(g,
b,l);l.isInherited?(a.addClass(tdcCssEditor._INHERITED_CSS_CLASS),e.hide()):(a.removeClass(tdcCssEditor._INHERITED_CSS_CLASS),e.show());d.isUndefined(g)?(c.val(""),e.hide(),tdcCssEditor._updateData(c),tdcCssEditor._checkDefaultColor(c)):(c.val(""),c.attr("placeholder",g),m.attr("style","background-color: "+tdcCssEditor._getRgba(g)),tdcCssEditor._updateData(c))},_inheritImage:function(e){var a=f(e.currentTarget);e=a.closest(".tdc-property-wrap");var c=e.find(".tdc-css-image-wrap"),m=e.find(".tdc-css-image-remove");
...
else{var c=tdcIFrameData.getModel(d);tdcSidebarController.onUpdate(c,a.data("param_name"),"","");f(".tdc-responsiveness").replaceWith(tdcCssEditor.generateEditorResponsiveContent());tdcCssEditor.doActionPanelRender()}tb_remove()},[d,a],"Are you sure you want to clear all the CSS settings of the selected component?")},_changeTextInput:function(b){var a=f(b.currentTarget),c=a.parent(),e=a;c.hasClass("tdc-box-margin")||c.hasClass("tdc-box-border")||c.hasClass("tdc-box-padding")||(e=a.closest(".tdc-property-wrap"));
c=a.val();var g=1;a.hasClass("tdc-css-opacity")&&(g=.01);var l=NaN;switch(b.type){case "keyup":switch(b.keyCode){case 38:f.isNumeric(c)&&(l=parseFloat(c)+g);break;case 40:f.isNumeric(c)&&(l=parseFloat(c)-g)}break;case "mousewheel":b.preventDefault(),b.stopImmediatePropagation(),f.isNumeric(c)&&(l=0<b.originalEvent.deltaY?parseFloat(c)-g:parseFloat(c)+g)}d.isNaN(l)||(1>g&&(l=l.toFixed(2)),a.val(l));tdcCssEditor._updateData(a);c=e.data("tdc-for");b={isInherited:!1};c=tdcCssEditor._getSettingsProperty(c,
...
c=a.find(".tdc-inherit-select");a.removeClass(tdcCssEditor._INHERITED_CSS_CLASS);tdcCssEditor._updateData(b);var e=a.data("tdc-for"),g={isInherited:!1};tdcCssEditor._getSettingsProperty(e,"",g);g.isInherited?(a.addClass(tdcCssEditor._INHERITED_CSS_CLASS),c.hide()):(a.removeClass(tdcCssEditor._INHERITED_CSS_CLASS),"all"===tdcSidebar.currentViewportSettings.name?c.hide():0===b[0].selectedIndex?d.isUndefined(tdcCssEditor._currentCssSettings.all)||d.isUndefined(tdcCssEditor._currentCssSettings.all[e])?
...
a+'"></div>'),f("body").append(c),c.find("input").on("input",function(a){var b=f(this),e=tdcAdminIFrameUI.getLiveIframe(),k=b.data("scroll-bar-width");c.find("output").html(b.val());tdcCssEditor.timeoutMediaInterval=setTimeout(function(){d.isUndefined(tdcCssEditor.timeoutMediaInterval)||clearTimeout(tdcCssEditor.timeoutMediaInterval);e.css("width",parseInt(b.val())+parseInt(k))},200)}));""===b?c.hide():(c.show(),tdcCssEditor.timeoutIframeHtml=setTimeout(function(){d.isUndefined(tdcCssEditor.timeoutIframeHtml)||
...
a+'"':""}function c(){return k.isInherited?" "+tdcCssEditor._INHERITED_CSS_CLASS:""}function m(a,b){var f=tdcCssEditor._getSettingsProperty(a,b,e()),h="-",m="";k.isInherited&&(h=f,f="");d.isUndefined(l)||"margin-left"!==a&&"margin-right"!==a||(m=l.get("tag"),m="vc_column"===m||"vc_column_inner"===m?" "+tdcCssEditor._INACTIVE_CSS_CLASS:"");return'<input data-tdc-for="'+a+'" name="" type="text" value="'+f+'" class="tdc-css-box-input tdc-css-box-input-'+a+c()+m+'" title="Css '+a+'" placeholder="'+h+
'" '+tdcSidebarPanel._getParamterDataAtts(g,l)+"/>"}tdcSidebarPanel._hook.removeAction("panel_css");var g=tdcCssEditor._mappedParameter,l=tdcCssEditor._model,k={isInherited:!1};var h='<div class="tdc-responsiveness"><div class="'+(tdcSidebarPanel._getParameterClasses(g)+'">');h=h+'<div class="tdc-box-margin"><div class="tdc-margin-label">Margin</div>'+m("margin-top","");h+=m("margin-right","");h+=m("margin-bottom","");h+=m("margin-left","");h=h+'<div class="tdc-box-border"><div class="tdc-border-label">Border</div>'+
m("border-top-width","");h+=m("border-right-width","");h+=m("border-bottom-width","");h+=m("border-left-width","");h=h+'<div class="tdc-box-padding"><div class="tdc-padding-label">Padding</div>'+m("padding-top","");h+=m("padding-right","");h+=m("padding-bottom","");h+=m("padding-left","");h+="</div></div></div></div>";var n=tdcCssEditor._getSettingsProperty("border-style",b,e());h+='<div class="tdc-property-wrap tdc-border-style tdc-dropdown-big'+c()+'" data-tdc-for="border-style">';h=h+'<div class="tdc-property-title"><span title="Css border-style" class="tdc-search-data">Border style<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-select"></div></span></div><div class="tdc-property"><select class="tdc-css-border-style" '+
...
n);h+="</select></div></div>";n=d.uniqueId();var p=tdcCssEditor._getSettingsProperty("border-color","",e()),q="";k.isInherited&&(q=p,p="");h+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-border-color'+c()+'" data-tdc-for="border-color">';h=h+'<div class="tdc-property-title"><span title="Css border-color" class="tdc-search-data">Border color<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+
('<input class="tdc-css-border-color" '+tdcSidebarPanel._getParamterDataAtts(g,l)+tdcCssEditor._getDataNoValue(p)+' data-default_value="#888888" id="'+n+'" name="" type="text" '+a(q)+' value="'+p+'"/>');h+="</div></div>";n=tdcCssEditor._getSettingsProperty("border-radius","",e());p="";k.isInherited&&(p=n,n="");h+='<div class="tdc-property-wrap tdc-border-radius tdc-textfield-small'+c()+'" data-tdc-for="border-radius">';h=h+'<div class="tdc-property-title"><span title="Css border-radius" class="tdc-search-data">Border radius</span></div><div class="tdc-property"><input class="tdc-css-border-radius" '+
(tdcSidebarPanel._getParamterDataAtts(g,l)+' name="" type="text" '+a(p)+' value="'+n+'"/>');h+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small "></div>';n=tdcCssEditor._getSettingsProperty("width","",e());p="";k.isInherited&&(p=n,n="");h+='<div class="tdc-property-wrap tdc-width tdc-textfield-big'+c()+'" data-tdc-for="width">';h=h+'<div class="tdc-property-title"><span title="Css shadow-size" class="tdc-search-data">Width</span></div><div class="tdc-property"><input class="tdc-css-width" '+
(tdcSidebarPanel._getParamterDataAtts(g,l)+' name="" type="text" '+a(p)+' value="'+n+'"/>');h+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small "></div>';n=tdcCssEditor._getSettingsProperty("shadow-size","",e());p="";k.isInherited&&(p=n,n="");h+='<div class="tdc-property-wrap tdc-shadow-size tdc-textfield-small'+c()+'" data-tdc-for="shadow-size">';h=h+'<div class="tdc-property-title"><span title="Css shadow-size" class="tdc-search-data">Shadow size</span></div><div class="tdc-property"><input class="tdc-css-shadow-size" '+
(tdcSidebarPanel._getParamterDataAtts(g,l)+' name="" type="text" '+a(p)+' value="'+n+'"/>');h+="</div></div>";n=d.uniqueId();p=tdcCssEditor._getSettingsProperty("shadow-color","",e());q="";k.isInherited&&(q=p,p="");h+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-shadow-color'+c()+'" data-tdc-for="shadow-color">';h=h+'<div class="tdc-property-title"><span title="Css shadow-color" class="tdc-search-data">Shadow color<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+
('<input class="tdc-css-shadow-color" '+tdcSidebarPanel._getParamterDataAtts(g,l)+tdcCssEditor._getDataNoValue(p)+' data-default_value="#888888" id="'+n+'" name="" type="text" '+a(q)+' value="'+p+'"/>');h+="</div></div>";n=tdcCssEditor._getSettingsProperty("shadow-offset-h","",e());p="";k.isInherited&&(p=n,n="");h+='<div class="tdc-property-wrap tdc-shadow-size tdc-textfield-small'+c()+'" data-tdc-for="shadow-offset-h">';h=h+'<div class="tdc-property-title"><span title="Css shadow-offset-h" class="tdc-search-data">Shadow offset H</span></div><div class="tdc-property"><input class="tdc-css-shadow-offset-h" '+
(tdcSidebarPanel._getParamterDataAtts(g,l)+' name="" type="text" '+a(p)+' value="'+n+'"/>');h+="</div></div>";n=tdcCssEditor._getSettingsProperty("shadow-offset-v","",e());p="";k.isInherited&&(p=n,n="");h+='<div class="tdc-property-wrap tdc-shadow-size tdc-textfield-small'+c()+'" data-tdc-for="shadow-offset-v">';h=h+'<div class="tdc-property-title"><span title="Css shadow-offset-v" class="tdc-search-data">Shadow offset V</span></div><div class="tdc-property"><input class="tdc-css-shadow-offset-v" '+
(tdcSidebarPanel._getParamterDataAtts(g,l)+' name="" type="text" '+a(p)+' value="'+n+'"/>');h+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small"></div>';n=d.uniqueId();p=tdcCssEditor._getSettingsProperty("background-color","",e());q="";k.isInherited&&(q=p,p="");h+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-bg-color'+c()+'" data-tdc-for="background-color">';h=h+'<div class="tdc-property-title"><span title="Css background-color" class="tdc-search-data">Background color<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+
('<input class="tdc-css-bg-color" '+tdcSidebarPanel._getParamterDataAtts(g,l)+tdcCssEditor._getDataNoValue(p)+' id="'+n+'" name="" type="text" '+a(q)+' value="'+p+'"/>');h+="</div></div>";tdcCssEditor._getSettingsProperty("background-image",b,e());h+='<div class="tdc-property-wrap tdc-property-attach_image'+c()+'">';h=h+'<div class="tdc-property-title"><span title="Css background-image" class="tdc-search-data">Background image<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-image"></div></span></div><div class="tdc-property"><div class="tdc-css-bg-image tdc-css-image-wrap " '+
...
(tdcSidebarPanel._getParamterDataAtts(g,l)+' name="">');h+=tdcCssEditor._generateDropdownOptions([{value:"center top",display:"Center Top"},{value:"center center",display:"Center Center"},{value:"center bottom",display:"Center Bottom"},{value:"left top",display:"Left Top"},{value:"left center",display:"Left Center"},{value:"left bottom",display:"Left Bottom"},{value:"right top",display:"Right Top"},{value:"right center",display:"Right Center"},{value:"right bottom",display:"Right Bottom"}],n);h+=
"</select></div></div>";n=tdcCssEditor._getSettingsProperty("opacity","",e());p="";k.isInherited&&(p=n,n="");h+='<div class="tdc-property-wrap tdc-opacity tdc-textfield-small'+c()+'" data-tdc-for="opacity">';h=h+'<div class="tdc-property-title"><span title="Css background-image opacity" class="tdc-search-data">Background opacity</span></div><div class="tdc-property"><input class="tdc-css-opacity" '+(tdcSidebarPanel._getParamterDataAtts(g,l)+' name="" type="text" '+a(p)+' value="'+n+'"/>');h+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small"></div>';
n=d.uniqueId();p=tdcCssEditor._getSettingsProperty("color-1-overlay","",e());q="";k.isInherited&&(q=p,p="");h+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-color-1-overlay'+c()+'" data-tdc-for="color-1-overlay">';h=h+'<div class="tdc-property-title"><span title="Css gradient color From" class="tdc-search-data">Color 1 overlay<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+
('<input class="tdc-css-color-1-overlay" '+tdcSidebarPanel._getParamterDataAtts(g,l)+tdcCssEditor._getDataNoValue(p)+' id="'+n+'" name="" type="text" '+a(q)+' value="'+p+'"/>');h+="</div></div>";n=d.uniqueId();p=tdcCssEditor._getSettingsProperty("color-2-overlay","",e());q="";k.isInherited&&(q=p,p="");h+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-color-2-overlay'+c()+'" data-tdc-for="color-2-overlay">';h=h+'<div class="tdc-property-title"><span  title="Css gradient color To" class="tdc-search-data">Color 2 overlay<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+
('<input class="tdc-css-color-2-overlay" '+tdcSidebarPanel._getParamterDataAtts(g,l)+tdcCssEditor._getDataNoValue(p)+' id="'+n+'" name="" type="text" '+a(q)+' value="'+p+'"/>');h+="</div></div>";n=tdcCssEditor._getSettingsProperty("gradient-direction","",e());p="";k.isInherited&&(p=n,n="");h+='<div class="tdc-property-wrap tdc-opacity tdc-textfield-small'+c()+'" data-tdc-for="gradient-direction">';h=h+'<div class="tdc-property-title"><span title="Css gradient direction" class="tdc-search-data">Gradient direction</span></div><div class="tdc-property"><input class="tdc-css-gradient-direction" '+
(tdcSidebarPanel._getParamterDataAtts(g,l)+' name="" type="text" '+a(p)+' value="'+n+'"/>');h+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small"></div>';n=tdcCssEditor._getSettingsProperty("content-h-align",b,e());h+='<div class="tdc-property-wrap tdc-bg-position tdc-dropdown-big'+c()+'" data-tdc-for="content-h-align">';h=h+'<div class="tdc-property-title"><span title="Css content horizontal align" class="tdc-search-data">H. align<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-select"></div></span></div><div class="tdc-property"><select class="tdc-css-content-h-align" '+
(tdcSidebarPanel._getParamterDataAtts(g,l)+' name="">');h+=tdcCssEditor._generateDropdownOptions([{value:"",display:"Default"},{value:"content-horiz-left",display:"Left"},{value:"content-horiz-center",display:"Center"},{value:"content-horiz-right",display:"Right"}],n);h+="</select></div></div>";n=tdcCssEditor._getSettingsProperty("z-index","",e());p="";k.isInherited&&(p=n,n="");h+='<div class="tdc-property-wrap tdc-opacity tdc-textfield-small'+c()+'" data-tdc-for="z-index">';h=h+'<div class="tdc-property-title"><span title="Z-index" class="tdc-search-data">Z-index</span></div><div class="tdc-property"><input class="tdc-css-z-index" '+
(tdcSidebarPanel._getParamterDataAtts(g,l)+' name="" type="text" '+a(p)+' value="'+n+'"/>');h+="</div></div>";n=tdcCssEditor._getSettingsPropertyFromCssSettings("display",b);h+='<div class="tdc-property-wrap tdc-display tdc-dropdown-big'+c()+'" data-tdc-for="display">';h=h+'<div class="tdc-property-title"><span title="Css content horizontal align" class="tdc-search-data">Display</span></div><div class="tdc-property"><select class="tdc-css-display" '+(tdcSidebarPanel._getParamterDataAtts(g,l)+' name="">');
h+=tdcCssEditor._generateDropdownOptions([{value:"",display:"Show"},{value:"none",display:"Hidden"},{value:"inline",display:"Inline"},{value:"inline-block",display:"Inline-block"},{value:"block",display:"Block"},{value:"table",display:"Table"},{value:"inline-table",display:"Inline-table"}],n);h=h+'</select></div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator"></div><div class="tdc-clear-css-properties" '+(tdcSidebarPanel._getParamterDataAtts(g,
l)+' title="Clear all tab css settings">Clear CSS settings</div>');h+="</div>";tdcSidebarPanel._hook.addAction("panel_css",tdcCssEditor.callbackColorPicker);tdcSidebarPanel._hook.addAction("panel_css",function(){f(".tdc-inherit").each(function(a,c){var e=f(c),g=e.closest(".tdc-property-wrap");if("all"===tdcSidebar.currentViewportSettings.name||g.hasClass(tdcCssEditor._INHERITED_CSS_CLASS))e.hide();else{var l=g.data("tdc-for");g={isInherited:!1};l=tdcCssEditor._getSettingsProperty(l,b,g);g.isInherited?
e.hide():d.isUndefined(l)||e.show()}})});return h},_getAvailableViewportSetting:function(b,a,c){if("undefined"!==typeof tdcCssEditor._currentCssSettings){var d;switch(b){case "all":"undefined"!==typeof tdcCssEditor._currentCssSettings[b]&&(d="all");break;case "landscape":case "portrait":case "phone":"undefined"!==typeof tdcCssEditor._currentCssSettings[b]?d=b:"undefined"!==typeof tdcCssEditor._currentCssSettings.all&&(d="all")}if("undefined"!==typeof d){if("undefined"!==typeof tdcCssEditor._currentCssSettings[d][a])return tdcSidebar.currentViewportSettings.name!==
...
l=!1,k=0,h=0;h<b.length;h++)d.isUndefined(c)||c!==b[h].value||(k=h),f="",d.isUndefined(a)||a!==b[h].value||(f='selected="selected"',l=!0),e.push("<option "+f+' value="'+b[h].value+'">'+b[h].display+"</option>");l||(e[k]='<option selected="selected" value="'+b[k].value+'">'+b[k].display+"</option>");return e.join("")},_generateCssAttValue:function(b){var a={},c=b.find(".tdc-css-box-input-margin-top").val().trim(),e=b.find(".tdc-css-box-input-margin-right").val().trim(),f=b.find(".tdc-css-box-input-margin-bottom").val().trim(),
l=b.find(".tdc-css-box-input-margin-left").val().trim(),k=b.find(".tdc-css-box-input-border-top-width").val().trim(),h=b.find(".tdc-css-box-input-border-right-width").val().trim(),n=b.find(".tdc-css-box-input-border-bottom-width").val().trim(),p=b.find(".tdc-css-box-input-border-left-width").val().trim(),q=b.find(".tdc-css-box-input-padding-top").val().trim(),t=b.find(".tdc-css-box-input-padding-right").val().trim(),v=b.find(".tdc-css-box-input-padding-bottom").val().trim(),u=b.find(".tdc-css-box-input-padding-left").val().trim(),
r=b.find(".tdc-css-border-radius").val().trim(),w=b.find(".tdc-css-width").val().trim(),A=b.find(".tdc-css-shadow-size").val().trim(),x=b.find(".tdc-css-shadow-offset-h").val().trim(),z=b.find(".tdc-css-shadow-offset-v").val().trim(),y=b.find(".tdc-css-opacity").val().trim(),B=b.find(".tdc-css-gradient-direction").val().trim(),C=b.find(".tdc-css-z-index").val().trim();""!==c&&(a["margin-top"]=c);""!==e&&(a["margin-right"]=e);""!==f&&(a["margin-bottom"]=f);""!==l&&(a["margin-left"]=l);""!==k&&(a["border-top-width"]=
k);""!==h&&(a["border-right-width"]=h);""!==n&&(a["border-bottom-width"]=n);""!==p&&(a["border-left-width"]=p);""!==q&&(a["padding-top"]=q);""!==t&&(a["padding-right"]=t);""!==v&&(a["padding-bottom"]=v);""!==u&&(a["padding-left"]=u);c=b.find(".tdc-css-border-style");e=c.val().trim();""===e||c.closest(".tdc-property-wrap").hasClass(tdcCssEditor._INHERITED_CSS_CLASS)||(a["border-style"]=e);c=b.find(".tdc-css-border-color");e=c.val().trim();""!==e?a["border-color"]=e:(c=c.data("no_value"),d.isUndefined(c)||
...
e[c]){b=!0;break}if("tdc_zone"!==d||"type"!==a)b||delete f[a]}if(!_.isUndefined(window.tdcAdminSettings.mappedShortcodes[d].tdc_start_values)){a=JSON.parse(tdcUtil.b64DecodeUnicode(window.tdcAdminSettings.mappedShortcodes[d].tdc_start_values));Array.isArray(a)&&(a=a[0]);for(var m in a)f.hasOwnProperty(m)||(f[m]=a[m])}}tdcContextMenu._model.set("attrs",f);tdcSidebarController.onUpdate(tdcContextMenu._model)}tdcContextMenu.hide()});tdcContextMenu.$_copyStyle.on("mouseover",function(f){""!==tdcContextMenu.$_copyListAttrs.html()&&
...
tdcContextMenu._model.get("tag");var b=tdcContextMenu._model.get("childCollection");if(!_.isUndefined(b))if("vc_column"===f||"vc_column_inner"===f)b.reset();else if("vc_row"===f||"vc_row_inner"===f)_.map(b.models,function(a,b){var c=a.get("childCollection");_.isUndefined(c)||c.reset()});else if("tdc_zone"===f){var e;_.map(b.models,function(a,b){_.isUndefined(e)&&(e=a);var c=a.get("childCollection");_.map(c.models,function(a,b){var c=a.get("childCollection");_.isUndefined(c)||c.reset()})});b=new tdcIFrameData.TdcCollection;
...
"vc_column_inner"===d){var a="";f=tdcContextMenu._model.get("childCollection");_.isUndefined(f)||_.map(f.models,function(b,d){var c={error:void 0,getShortcode:""};tdcIFrameData._checkModelData(b,c);_.isUndefined(c.getShortcode)||(a+=c.getShortcode)});tdcUtil.setStorageItem("copyShortcode",tdcUtil.b64EncodeUnicode(a))}else tdcUtil.setStorageItem("copyShortcode",tdcUtil.b64EncodeUnicode(f.getShortcode));tdcContextMenu.hide()},cutShortcodeHandler:function(f){tdcContextMenu.copyShortcodeHandler(f);tdcContextMenu.deleteHandler(f,
...
tdcContextMenu.hide()},setContextMenu:function(f,d){var b="",e=!0,a=!0;if(_.isUndefined(d))return!1;tdcOperationUI.isZone(d)?(b="Zone",e=!1,a=!0):tdcOperationUI.isRow(d)?b="Row":tdcOperationUI.isColumn(d)?(b="Column",e=!1):tdcOperationUI.isInnerRow(d)?b="Inner Row":tdcOperationUI.isInnerColumn(d)?(b="Inner Column",e=!1):tdcOperationUI.isElement(d)&&(b="Element",a=!1);if(""!==b){var c=d.data("model_id"),m=tdcIFrameData.getModel(c);c=m.get("tag");var g=0,l=tdcUtil.getStorageItem("copyShortcodeType"),
k=tdcUtil.getStorageItem("copyShortcode");tdcContextMenu._setCurrentElementOver(d);_.isUndefined(l)||_.isUndefined(k)||""===k?(tdcContextMenu._disable(tdcContextMenu.$_pasteShortcodeBefore),tdcContextMenu._disable(tdcContextMenu.$_pasteShortcodeAfter)):(k="tdc_zone"!==l&&"vc_row"!==l&&"vc_column"!==l&&"vc_row_inner"!==l&&"vc_column_inner"!==l,tdcOperationUI.isRow(d)&&"vc_row"===l||tdcOperationUI.isColumn(d)&&(k||"vc_row_inner"===l||"vc_column"===l)||tdcOperationUI.isInnerRow(d)&&(k||"vc_row_inner"===
l)||tdcOperationUI.isInnerColumn(d)&&(k||"vc_column_inner"===l)||tdcOperationUI.isElement(d)&&k||tdcOperationUI.isElement(d)&&"vc_row_inner"===l&&!d.hasClass("tdc-element-inner-column")?(tdcContextMenu._enable(tdcContextMenu.$_pasteShortcodeBefore),tdcContextMenu._enable(tdcContextMenu.$_pasteShortcodeAfter)):(tdcContextMenu._disable(tdcContextMenu.$_pasteShortcodeBefore),tdcContextMenu._disable(tdcContextMenu.$_pasteShortcodeAfter)));"Element"===b&&(b=window.tdcAdminSettings.mappedShortcodes[c].name);
tdcContextMenu._type=b;tdcContextMenu._model=m;!0===tdcMain.getSidebarInline()&&!1===tdcMain.getSidebarHidden()&&(g=tdcSidebar.$_sidebar.width());tdcContextMenu.$_currentType.html(b);"contextmousedown"===f.type&&tdcContextMenu.$_context.show().css({left:f.pageX+g,top:f.pageY-tdcAdminIFrameUI._liveIframeWindowObject.scrollY});tdcContextMenu.$_context.find(".tdc-copy-list-style, .tdc-paste-list-style").remove();b=!1;if(!_.isUndefined(window.tdcAdminSettings.listStyles))for(var h in window.tdcAdminSettings.listStyles)for(var n in window.tdcAdminSettings.listStyles[h])n===
c&&(tdcContextMenu.$_copyListAttrs.append('<li class="tdc-copy-list-style active" data-list-style="'+h+'">Copy '+h+"</li>"),tdcContextMenu.$_pasteListAttrs.append('<li class="tdc-paste-list-style active" data-list-style="'+h+'">Paste '+h+"</li>"),b=!0);b?(tdcContextMenu.$_copyAttrs.show(),tdcContextMenu.$_copyStyle.find("i").show(),tdcContextMenu.$_pasteStyle.find("i").show()):(tdcContextMenu.$_copyAttrs.hide(),tdcContextMenu.$_copyStyle.find("i").hide(),tdcContextMenu.$_pasteStyle.find("i").hide());
h=tdcUtil.getStorageItem("copyStyleType");n=tdcUtil.getStorageItem("copyStyleAttrs");_.isUndefined(window.tdcAdminSettings.mappedShortcodes[c].tdc_style_params)&&!b?(tdcContextMenu._disable(tdcContextMenu.$_copyStyle),tdcContextMenu._disable(tdcContextMenu.$_resetStyle)):(tdcContextMenu._enable(tdcContextMenu.$_copyStyle),tdcContextMenu._enable(tdcContextMenu.$_resetStyle));_.isUndefined(h)||_.isUndefined(n)?tdcContextMenu._disable(tdcContextMenu.$_pasteStyle):tdcContextMenu._enable(tdcContextMenu.$_pasteStyle);
...
return a};d.prototype.compressCSS=function(b){for(var d=[],a={},c=0;c<b.length;c++){var f=b[c];if(!0!==a[f.selector]){var g=this.findBySelector(b,f.selector);0!==g.length&&(d.push(g[0]),a[f.selector]=!0)}}return d};d.prototype.cssDiff=function(b,d){if(b.selector!==d.selector||"media"===b.type||"media"===d.type)return!1;for(var a={selector:b.selector,rules:[]},c,e,f=0;f<b.rules.length;f++)c=b.rules[f],e=this.findCorrespondingRule(d.rules,c.directive,c.value),!1===e?a.rules.push(c):c.value!==e.value&&
...
a.appendChild(c);c.styleSheet&&!c.sheet?c.styleSheet.cssText=d:c.appendChild(document.createTextNode(d))};f.cssjs=d})(this);jQuery("#tdc-live-iframe").load(function(){jQuery("body").addClass("tdcComposerLoaded")});var tdcLivePanel;
