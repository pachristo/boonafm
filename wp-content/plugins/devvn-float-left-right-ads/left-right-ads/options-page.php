			...
			<tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <label>By Page ID or Post ID <input type="text" name="<?php echo $this->_optionName?>[exclude_page]" placeholder="Ex: 23,34,99" value="<?php echo $flra_options['exclude_page']?>" style="width: 230px;"></label><br>
                    </td>
                </tr>
				<tr>
					<th scope="row"><label for="screen_w">Show ads if client <strong>screen width</strong> >=</label></th>
					<td>
						<input type="number" name="<?php echo $this->_optionName?>[screen_w]" id="screen_w" value="<?php echo $flra_options['screen_w']?>"/> px
					</td>
				</tr>
				<tr>
					<th scope="row"><label for="content_w">Main content width:</label></th>
					<td>
						<input type="number" name="<?php echo $this->_optionName?>[content_w]" id="content_w" value="<?php echo $flra_options['content_w']?>"/> px
				...
				<tr>
					...
					<td>
						<table>
							<tr>
								<td style="padding:0">
									<input type="number" name="<?php echo $this->_optionName?>[banner_left_w]" id="banner_left_w" value="<?php echo $flra_options['banner_left_w']?>"/> px<br>
									<p class="description">Width of your left banner.</p>
								</td>
								<td style="padding:0 0 0 10px">
									<input type="number" name="<?php echo $this->_optionName?>[banner_left_h]" id="banner_left_h" value="<?php echo $flra_options['banner_left_h']?>"/> px<br>
				...
				<tr>
					...
					<td>
						<table>
							<tr>
								<td style="padding:0">
									<input type="number" name="<?php echo $this->_optionName?>[banner_right_w]" id="banner_right_w" value="<?php echo $flra_options['banner_right_w']?>"/> px<br>
									<p class="description">Width of your right banner.</p>
								</td>
								<td style="padding:0 0 0 10px">
									<input type="number" name="<?php echo $this->_optionName?>[banner_right_h]" id="banner_right_h" value="<?php echo $flra_options['banner_right_h']?>"/> px<br>
				...
				<tr>
					...
					<td>
						<input type="number" name="<?php echo $this->_optionName?>[margin_l]" id="margin_l" value="<?php echo $flra_options['margin_l']?>"/> px<br>
				...
				<tr>
					...
					<td>
						<input type="number" name="<?php echo $this->_optionName?>[margin_r]" id="margin_r" value="<?php echo $flra_options['margin_r']?>"/> px<br>
				...
				<tr>
					...
					<td>
						<input type="number" name="<?php echo $this->_optionName?>[margin_t]" id="margin_t" value="<?php echo $flra_options['margin_t']?>"/> px<br>
				...
				<tr>
					...
					<td>
						<input type="number" min="0" name="<?php echo $this->_optionName?>[margin_t_scroll]" id="margin_t_scroll" value="<?php echo $flra_options['margin_t_scroll']?>"/> px<br>
				...
				<tr>
					...
					<td>
						<input type="number" name="<?php echo $this->_optionName?>[z_index]" id="z_index" value="<?php echo $flra_options['z_index']?>"/>
					</td>
				</tr>
				<tr>
