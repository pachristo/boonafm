...
$container = apply_filters('emd_change_container','emd-wrapper','employee_spotlight', 'taxonomy');  
...
<?php
	do_action('emd_tax_before_header', 'employee-spotlight',$post->post_type,$queried_object->taxonomy);
	emd_get_template_part('employee-spotlight', 'taxonomy', str_replace("_","-",$queried_object->taxonomy . '-' . $post->post_type) . '-theader');
	do_action('emd_tax_after_header', 'employee-spotlight',$post->post_type,$queried_object->taxonomy);
?>
	</div>
...
<?php
	do_action('emd_tax_before_footer', 'employee-spotlight',$post->post_type,$queried_object->taxonomy);
	emd_get_template_part('employee-spotlight', 'taxonomy', str_replace("_","-",$queried_object->taxonomy . '-' . $post->post_type) . '-tfooter');
	do_action('emd_tax_after_footer', 'employee-spotlight',$post->post_type,$queried_object->taxonomy);
?>
</div>
