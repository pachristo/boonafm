...
$container = apply_filters('emd_change_container','emd-wrapper','employee_spotlight', 'single'); 
...
<?php 	}
	...
	$show_edit_link = apply_filters('emd_show_single_edit_link',true,'employee_spotlight');
	if($show_edit_link){
