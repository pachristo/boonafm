...
$container = apply_filters('emd_change_container','emd-wrapper','employee_spotlight', 'archive');  
...
<?php
	do_action('emd_archive_before_header', 'employee-spotlight',$post->post_type);
	emd_get_template_part('employee-spotlight', 'archive', str_replace("_","-",$post->post_type) . '-aheader');
	do_action('emd_archive_after_header', 'employee-spotlight',$post->post_type);
?>
	</div>
...
<?php
	do_action('emd_archive_before_footer', 'employee-spotlight',$post->post_type);
	emd_get_template_part('employee-spotlight', 'archive', str_replace("_","-",$post->post_type) . '-afooter');
	do_action('emd_archive_after_footer', 'employee-spotlight',$post->post_type);
?>
</div>
